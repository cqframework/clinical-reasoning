...
public class Parameters {
    ...
    public static IBaseParameters newParameters(FhirContext fhirContext, String theId,
            IBase... parts) {
        checkNotNull(theId);
        IIdType id = (IIdType) Objects.requireNonNull(fhirContext.getElementDefinition("id"))
                .newInstance();
        id.setValue(theId);
    ...
    public static Optional<String> getSingularStringPart(FhirContext fhirContext,
        ...
        checkNotNull(name);
        return ParametersUtil.getNamedParameterValueAsString(fhirContext,
                (IBaseParameters) parameters, name);
    }
