...
class QuestionnaireProcessorTest {
    ...
    @Mock
    private PopulateProcessor myPopulateService;
    @Mock
    private ResolveProcessor myResolveService;
    @Mock
    private PackageProcessor myPackageService;
    @Mock
    private PrePopulateProcessor myPrePopulateService;
    @Mock
    ...
    @InjectMocks
    private QuestionnaireProcessor myFixture;
