...
public abstract class BaseActivityDefinitionProcessor<T> {
    ...
    public IBaseResource apply(IIdType theId, String subjectId, String encounterId,
            ...
            IBaseParameters parameters, IBaseResource contentEndpoint,
        ...
        return resolveActivityDefinition(activityDefinition, subjectId, practitionerId,
                organizationId);
    }
    ...
    public void resolveDynamicValue(String language, String expression, String libraryUrl,
        ...
        switch (language) {
            ...
            case "text/cql-expression":
                logger.warn(
                        "CQL expressions in ActivityDefinition dynamicActions is not supported.");
                break;
            case "text/cql.name":
            case "text/cql-name":
