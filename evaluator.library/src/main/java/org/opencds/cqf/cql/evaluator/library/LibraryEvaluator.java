...
public class LibraryEvaluator {
     ...
     * evaluates the CQL library and expressions specified. It then returns the CQL results as a
    ...
    public IBaseParameters evaluate(VersionedIdentifier libraryIdentifier,
            Pair<String, Object> contextParameter, IBaseParameters parameters,
