...
import org.opencds.cqf.cql.evaluator.questionnaireresponse.Constants;
...
public class QuestionnaireResponseProcessor extends BaseQuestionnaireResponseProcessor<QuestionnaireResponse> {
    ...
    public List<IBaseResource> processItems(QuestionnaireResponse questionnaireResponse) {
        ...
        // TODO: fix this
        var itemExtractionContext = questionnaireResponse.getExtensionsByUrl(Constants.SDC_QUESTIONNAIRE_ITEM_EXTRACTION_CONTEXT).get(0);
    ...
    private void processGroupItem(
        ...
        // TODO: fix this
        var itemExtractionContext = item.getExtensionsByUrl(Constants.SDC_QUESTIONNAIRE_ITEM_EXTRACTION_CONTEXT).get(0);
        if (itemExtractionContext != null) {
