...
class PackageProcessorTests {
    ...
    void testPOST() {
        ...
        Assertions.assertEquals(HTTPVerb.POST, entry.getRequest().getMethod());
        Assertions.assertEquals(resource, BundleHelper.getEntryResourceFirstRep(bundle));
    }
    ...
    void testPUT() {
        ...
        assertNotNull(bundle);
        var entry = (BundleEntryComponent) BundleHelper.getEntryFirstRep(bundle);
        Assertions.assertEquals(HTTPVerb.PUT, entry.getRequest().getMethod());
        Assertions.assertEquals(resource, BundleHelper.getEntryResourceFirstRep(bundle));
    }
}
