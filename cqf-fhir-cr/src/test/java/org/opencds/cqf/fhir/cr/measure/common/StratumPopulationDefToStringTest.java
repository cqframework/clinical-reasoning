...
class StratumPopulationDefToStringTest {
    ...
    //                populationDef, subjects, intersection, resourceIds, MeasureStratifierType.CRITERIA,
    // populationBasis);
    //        String result = stratumDef.toString();
    //
    //        // Then: Should contain populationDef with id, measureStratifierType, and populationBasis
    //        assertTrue(
    //                result.contains("populationDef=PopulationDef{id='stratum-1'"), "Should contain PopulationDef with
    // id");
    ...
    //        assertTrue(result.contains("populationDefEvaluationResultIntersection="), "Should contain intersection
    // field");
    //
    ...
    //        // When
    //        StratumPopulationDef stratumDef = new StratumPopulationDef(
    //                populationDef, subjects, quantities, resourceIds, MeasureStratifierType.CRITERIA,
    // populationBasis);
    //        String result = stratumDef.toString();
    //
    ...
    //        Set<String> subjects = Set.of("Patient/1", "Patient/2", "Patient/3", "Patient/4", "Patient/5",
    // "Patient/6");
    //        List<String> resourceIds = List.of("res1", "res2", "res3", "res4", "res5", "res6", "res7", "res8",
    // "res9");
    //        CodeDef populationBasis = new CodeDef(null, null, "Encounter", null);
    //        PopulationDef populationDef = new PopulationDef(
    ...
    //        assertTrue(
    //                result.contains("resourceIdsForSubjectList=") && result.contains("...]"), "Should truncate
    // resources");
    //    }
    //
    //    @Test
    ...
    //        // When
    //        StratumPopulationDef stratumDef = new StratumPopulationDef(
    //                populationDef, subjects, fivePatients, resourceIds, MeasureStratifierType.CRITERIA,
    // populationBasis);
    //        String result = stratumDef.toString();
    //
    ...
    //        String intersectionSection =
    // result.substring(result.indexOf("populationDefEvaluationResultIntersection="));
    //
