...
public class DynamicValueProcessor {
    ...
    public DynamicValueProcessor(
            LibraryEngine libraryEngine, ModelResolver modelResolver, FhirVersionEnum fhirVersion) {
    ...
    protected String getDynamicValuePath(IBaseBackboneElement dynamicValue) {
        switch (fhirVersion) {
            case DSTU3:
                return ((org.hl7.fhir.dstu3.model.ActivityDefinition.ActivityDefinitionDynamicValueComponent)
                                dynamicValue)
                        .getPath();
            case R4:
                return ((org.hl7.fhir.r4.model.ActivityDefinition.ActivityDefinitionDynamicValueComponent) dynamicValue)
                        .getPath();
            case R5:
                return ((org.hl7.fhir.r5.model.ActivityDefinition.ActivityDefinitionDynamicValueComponent) dynamicValue)
                        .getPath();
            default:
                return null;
        }
    ...
    protected CqfExpression getDynamicValueExpression(IBaseBackboneElement dynamicValue, String defaultLibraryUrl) {
        switch (fhirVersion) {
            case DSTU3:
                var dstu3Value = (org.hl7.fhir.dstu3.model.ActivityDefinition.ActivityDefinitionDynamicValueComponent)
                        dynamicValue;
                return new CqfExpression(dstu3Value.getLanguage(), dstu3Value.getExpression(), defaultLibraryUrl);
            case R4:
                var r4Value = ((org.hl7.fhir.r4.model.ActivityDefinition.ActivityDefinitionDynamicValueComponent)
                                dynamicValue)
                        .getExpression();
                return r4Value == null
                        ? null
            ...
            case R5:
                var r5Value = ((org.hl7.fhir.r5.model.ActivityDefinition.ActivityDefinitionDynamicValueComponent)
                                dynamicValue)
                        .getExpression();
                return r5Value == null
                        ? null
