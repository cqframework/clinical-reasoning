...
public class QuestionnaireResponseProcessorTests {
  @Test
  void testExtract() {
    TestQuestionnaireResponse.Assert.that("questionnaire_response_1558.json").extract()
  ...
  void testIsSubjectExtension() {
    TestQuestionnaireResponse.Assert.that("questionnaire_response_is_subject.json").extract()
        .isEqualsTo("questionnaire_response_is_subject_bundle.json");
  }

  @Test
  void testDefinitionBasedExtraction() {
    TestQuestionnaireResponse.Assert.that("questionnaire_response_definition.json").extract()
        .isEqualsTo("questionnaire_response_definition_bundle.json");
  }

  @Test(enabled = false)
  void testDemographicsExtraction() {
    TestQuestionnaireResponse.Assert.that("questionnaire_response_demographics.json").extract()
