...
public class PlanDefinitionProcessorTests extends PlanDefinition {
    ...
    /*
     * Commenting these tests out until R5 support has been added to the translator
     * so these IG's can be updated
     */
    // @Test
    ...
    // /* NOTE:
    // All dynamicValues with the path equaling action.extension have been removed
    // from the
    // plandefinition until the issue in the link
