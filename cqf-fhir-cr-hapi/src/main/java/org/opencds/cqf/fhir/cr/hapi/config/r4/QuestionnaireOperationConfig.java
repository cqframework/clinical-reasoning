...
public class QuestionnaireOperationConfig {
    @Bean
    StructureDefinitionQuestionnaireProvider r4StructureDefinitionQuestionnaireProvider(
            IQuestionnaireProcessorFactory questionnaireProcessorFactory) {
        return new StructureDefinitionQuestionnaireProvider(questionnaireProcessorFactory);
    }
    ...
    public ProviderLoader questionnaireOperationLoader(
        ...
        var selector = new ProviderSelector(
                fhirContext, Map.of(FhirVersionEnum.R4, Arrays.asList(StructureDefinitionQuestionnaireProvider.class)));
