...
class CrDiscoveryServiceR4Test extends BaseCdsCrDiscoveryServiceTest {
    ...
    private static final IdType LIBRARY_1_ID_TYPE = new IdType(
        ResourceType.Library.toString(),
        "lib1");
    private static final IdType LIBRARY_2_ID_TYPE = new IdType(
        ResourceType.Library.toString(),
        "lib2");
    private static final IdType LIBRARY_3_ID_TYPE = new IdType(
        ResourceType.Library.toString(),
        "lib3");
    private static final IdType LIBRARY_4_ID_TYPE = new IdType(
        ResourceType.Library.toString(),
        "lib4");
    private static final IdType LIBRARY_5_ID_TYPE = new IdType(
        ResourceType.Library.toString(),
        "lib5");
    private static final IdType LIBRARY_6_ID_TYPE = new IdType(
        ResourceType.Library.toString(),
        "lib6");
    ...
    private static final Library LIBRARY_3 = buildLibrary(LIBRARY_3_ID_TYPE, LIBRARY_CANONICAL_3, DATA_REQUIREMENT_PATIENT);
    private static final Library LIBRARY_4 = buildLibrary(LIBRARY_4_ID_TYPE, LIBRARY_CANONICAL_4, DATA_REQUIREMENT_ENCOUNTER);
    private static final Library LIBRARY_5 = buildLibrary(LIBRARY_5_ID_TYPE, LIBRARY_CANONICAL_5, DATA_REQUIREMENT_PATIENT_CODE_FILTER_CODING_NON_EMPTY);
    private static final Library LIBRARY_6 = buildLibrary(LIBRARY_6_ID_TYPE, LIBRARY_CANONICAL_6, DATA_REQUIREMENT_ENCOUNTER_CODE_FILTER_CODING_NON_EMPTY);
    ...
    private static Stream<Arguments> getPrefetchUrlListParams() {
        return Stream.of(
            ...
            Arguments.of(new PlanDefinition().setType(
                ...
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(LIBRARY_CANONICAL_1)),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(LIBRARY_CANONICAL_2)),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(LIBRARY_CANONICAL_3)),
                getPrefetchUrlList(
                    PREFETCH_URL_PATIENT)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(LIBRARY_CANONICAL_4)),
                getPrefetchUrlList(
                    PREFETCH_URL_ENCOUNTER)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                List.of(LIBRARY_CANONICAL_3, LIBRARY_CANONICAL_4)),
                getPrefetchUrlList(PREFETCH_URL_PATIENT)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                    List.of(LIBRARY_CANONICAL_5)),
                getPrefetchUrlList(PREFETCH_URL_PATIENT_WITH_PATH_AND_CODE)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                        List.of(LIBRARY_CANONICAL_6)),
                getPrefetchUrlList(PREFETCH_URL_ENCOUNTER_WITH_PATH_AND_CODE)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                        List.of(LIBRARY_CANONICAL_5, LIBRARY_CANONICAL_6)),
                getPrefetchUrlList(PREFETCH_URL_PATIENT_WITH_PATH_AND_CODE))
        );
    }
