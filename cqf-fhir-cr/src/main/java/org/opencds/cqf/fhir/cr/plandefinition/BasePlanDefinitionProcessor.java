...
public abstract class BasePlanDefinitionProcessor<T> {
    ...
    protected abstract void resolveDynamicExtension(IElement requestAction, IBase resource, Object value, String path);
    ...
    public <CanonicalType extends IPrimitiveType<String>> IBaseBundle packagePlanDefinition(
            IIdType id, CanonicalType canonical, IBaseResource planDefinition, boolean isPut) {
        return packagePlanDefinition(resolvePlanDefinition(id, canonical, planDefinition), isPut);
    }
    ...
    public <CanonicalType extends IPrimitiveType<String>> IBaseResource applyR5(
            IIdType id,
            CanonicalType canonical,
            IBaseResource planDefinition,
            String patientId,
    ...
    public <CanonicalType extends IPrimitiveType<String>> IBaseResource applyR5(
        ...
        this.requestResources = new ArrayList<>();
        this.extractedResources = new ArrayList<>();
        return transformToBundle(applyPlanDefinition(initApply(resolvePlanDefinition(id, canonical, planDefinition))));
    }
