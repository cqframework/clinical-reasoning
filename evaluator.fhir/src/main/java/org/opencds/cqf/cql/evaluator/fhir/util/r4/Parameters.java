...
public class Parameters {
	...
	/**
	 * Method to create parameters for fhir r4 model via submission of parameter
	 * component
	 *
	 * @param parts Parameter r4 components
	 * @return parameters
	...
	/**
	 * Method to create parameters part for fhir r4 model via submission of
	 * parameter component
	 *
	 ...
	 */
	public static org.hl7.fhir.r4.model.Parameters.ParametersParameterComponent part(
			String name, org.hl7.fhir.r4.model.Type value,
			org.hl7.fhir.r4.model.Parameters.ParametersParameterComponent... parts) {
		checkNotNull(name);
		checkNotNull(value);
		org.hl7.fhir.r4.model.Parameters.ParametersParameterComponent c = part(name, parts);
