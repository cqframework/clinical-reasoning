        ...
        if (resource.fhirType().equals("Library")) {
            ...
            switch (fhirContext.getVersion().getVersion()) {
                case DSTU3:
                    ...
                    if (cqlLocation != null) {
                        resource = org.opencds.cqf.fhir.utility.dstu3.AttachmentUtil.addData(
                ...
                case R4:
                    ...
                    if (cqlLocation != null) {
                        resource = org.opencds.cqf.fhir.utility.r4.AttachmentUtil.addData(
                                resource, getCqlContent(location, cqlLocation));
                    }
                    break;
                case R5:
                    ...
                    if (cqlLocation != null) {
                        resource = org.opencds.cqf.fhir.utility.r5.AttachmentUtil.addData(
                                resource, getCqlContent(location, cqlLocation));
                    }
                    break;
                default:
