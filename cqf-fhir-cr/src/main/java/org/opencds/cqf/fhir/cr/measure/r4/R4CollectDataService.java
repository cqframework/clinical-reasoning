...
public class R4CollectDataService  {
     ...
     *
     * @param measureId         the Id of the Measure to sub data for
    ...
    private void addReports(R4MeasureProcessor processor, IdType measureId, String periodStart, String periodEnd, List<String> subjects, Parameters parameters){
    ...
    private List<String> getSubjects(String subject, String practitioner, R4RepositorySubjectProvider subjectProvider){
        ...
        return subjectProvider.getSubjects(repository, MeasureEvalType.SUBJECT, subject).collect(Collectors.toList());
    }
    protected void populateEvaluatedResources(MeasureReport measureReport, Parameters parameters, String subject) {
        ...
        measureReport.getEvaluatedResource().forEach(evaluatedResource -> {
            ...
            Class<? extends IBaseResource> resourceType = repository.fhirContext()
