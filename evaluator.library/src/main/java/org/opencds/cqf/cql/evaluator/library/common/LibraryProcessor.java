...
class LibraryProcessor {
    ...
    Logger logger = LoggerFactory.getLogger(LibraryProcessor.class);
    ...
    LibraryProcessor(FhirContext fhirContext, AdapterFactory adapterFactory, CqlEvaluator cqlEvaluator,
            LibraryLoader libraryLoader, ParameterParser parameterParser) {
