...
public class BundleRetrieveProviderTests {
  ...
  public void test_filterToCodes() {
    ...
    assertEquals(
        ((Condition) results.iterator().next()).getSubject().getReferenceElement().getIdPart(),
        "test-one-r4");
  }
  ...
  public void test_retrieveByUrn() {
    ...
    Iterable<Object> results = brp.retrieve("Patient", "id", "e527283b-e4b1-4f4e-9aef-8a5162816e32",
        "Patient", null, null, null, null, null, null, null, null);
    assertNotNull(results);
