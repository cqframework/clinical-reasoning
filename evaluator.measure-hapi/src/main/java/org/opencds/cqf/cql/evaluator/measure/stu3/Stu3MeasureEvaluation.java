...
//             MeasurePopulationType populationType, int populationCount,
//             Iterable<DomainResource> subjectPopulation) {
...
//         popCode.getCodingFirstRep().setCode(populationType.toCode());
//         populationReport.setCode(popCode);
...
//             for (DomainResource patient : subjectPopulation) {
//                 ListResource.ListEntryComponent entry = new ListResource.ListEntryComponent()
//                         .setItem(new Reference().setReference(String.format("Patient/%s", this.getId.apply(patient))));
//                 // TODO: patient name;
...
//     @Override
//     protected MeasureReport createMeasureReport(String status, MeasureReportType type, List<DomainResource> subjects) {
