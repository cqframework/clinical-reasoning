...
class QuestionnaireResponseOperationsProviderTest extends BaseCrR4TestServer {
    ...
    void testExtract() {
        ...
        loadResource(Questionnaire.class, "org/opencds/cqf/fhir/cr/hapi/r4/Questionnaire-MyPainQuestionnaire.json", requestDetails);
        var questionnaireResponse = readResource(
                QuestionnaireResponse.class, "org/opencds/cqf/fhir/cr/hapi/r4/QuestionnaireResponse-QRSharonDecision.json");
