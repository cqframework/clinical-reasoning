...
public class ContinuousVariableResourceMeasureObservationTest {
    ...
    class Sum {
        ...
        @Test
        void continuousVariableResourceMeasureObservationBooleanBasisAnotherSpecificSubjectId1Sum() {

            GIVEN_BOOLEAN_BASIS
                    .when()
                    .measureId("ContinuousVariableResourceMeasureObservationBooleanBasisSum")
                    .subject("patient-1940-female")
                    .evaluate()
                    .then()
                    // MeasureDef assertions (pre-scoring) - verify internal state after processing
                    .def()
        ...
        @Test
        void continuousVariableResourceMeasureObservationBooleanBasisAnotherSpecificSubjectId2Sum() {

            GIVEN_BOOLEAN_BASIS
                    .when()
                    .measureId("ContinuousVariableResourceMeasureObservationBooleanBasisSum")
                    .subject("patient-1955-other")
                    .evaluate()
                    .then()
                    // MeasureDef assertions (pre-scoring) - verify internal state after processing
                    .def()
                    ...
                    .population("measure-observation")
                    .hasCount(1)
                    .hasAggregationResultsExtensionValue(69.0)
                    .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                    .up()
                    .hasScore("69.0")
                    .stratifierById("stratifier-age")
