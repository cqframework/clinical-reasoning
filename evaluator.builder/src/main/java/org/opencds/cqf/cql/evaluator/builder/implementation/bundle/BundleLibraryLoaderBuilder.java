...
public class BundleLibraryLoaderBuilder {
    ...
    public void populateLibraryManager(LibraryManager libraryManager, IBaseBundle bundle, CqlTranslatorOptions cqlTranslatorOptions) {
        ...
        if (versionEnum.isOlderThan(FhirVersionEnum.DSTU2)) {
            throw new NotImplementedException("Sorry there is no Bundle Library Loader implementation for anything older than DSTU2 as of now.");
        }
        else if (versionEnum.isEqualOrNewerThan(FhirVersionEnum.DSTU2) && versionEnum.isOlderThan(FhirVersionEnum.DSTU3)) {
            throw new NotImplementedException("Sorry there is no Bundle Library Loader implementation for anything older than Dstu3 as of now.");        
        }
            ...
            throw new NotImplementedException("Sorry there is no Bundle Library Loader implementation for anything newer or equal to R4 as of now."); 
        }
