...
class MeasureScoringTypeRatioContVariableTest {
    ...
    void ratioContinuousVariableStratifierResource() {
        given.when()
                ...
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(5)
                .hasAggregationResult(570.0) // SUM(180,30,120,120,120)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .populationById("observation-num")
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4)
                .hasAggregationResult(450.0) // SUM(180,30,120,120)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .up()
                .stratumByValue("38")
                ...
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4)
                .hasAggregationResult(480.0) // SUM(120,120,120,120)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .populationById("observation-num")
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(3)
                .hasAggregationResult(360.0) // SUM(120,120,120)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .up()
                .up()
                ...
                .hasAggregationResultsExtensionValue(570.0) // SUM(180,30,120,120,120)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("denominator")
                .up()
                .populationId("observation-num")
                .hasCode(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4)
                .hasAggregationResultsExtensionValue(450.0) // SUM(180,30,120,120)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("numerator")
                .up()
                .up()
                ...
                .hasAggregationResultsExtensionValue(480.0) // SUM(120,120,120,120)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("denominator")
                .up()
                .populationId("observation-num")
                .hasCode(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(3)
                .hasAggregationResultsExtensionValue(360.0) // SUM(120,120,120)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("numerator")
                .up()
                .up()
    ...
    void ratioContinuousVariableStratifierBoolean() {
        given.when()
                ...
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4)
                .hasAggregationResult(144.0) // SUM(36,36,36,36)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .populationById("observation-num")
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(1)
                .hasAggregationResult(36.0) // SUM(36)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .up()
                .stratumByValue("F")
                ...
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4)
                .hasAggregationResult(156.0) // SUM(39,39,39,39)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .populationById("observation-num")
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(1)
                .hasAggregationResult(39.0) // SUM(39)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .up()
                .up()
                .up()
                ...
                .hasCode(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4) // we remove exclusions in these counts so users can see final Observation count used
                .hasAggregationResultsExtensionValue(144.0) // SUM(36,36,36,36)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("denominator")
                .up()
                .populationId("observation-num")
                .hasCode(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(1)
                .hasAggregationResultsExtensionValue(36.0) // SUM(36)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("numerator")
                .up()
                .up()
                ...
                .hasCode(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(4) // we remove exclusions in these counts so users can see final Observation count used
                .hasAggregationResultsExtensionValue(156.0) // SUM(39,39,39,39)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("denominator")
                .up()
                .populationId("observation-num")
                .hasCode(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(1)
                .hasAggregationResultsExtensionValue(39.0) // SUM(39)
                .hasAggregateMethodExtension(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReferenceExtension("numerator")
                .up()
                .up()
    ...
    /**
     * Test: Verify RCV validation passes when population IDs differ from type codes.
     * This is the DQM-700 regression test: criteria references like "Numerator_1" and "Denominator_1"
     * should be resolved by population ID, not compared directly against type codes.
     */
    @Test
    void ratioContinuousVariableResourceBasisSumArbitraryIds() {
        given.when()
                .measureId("RatioContVarResourceSumArbitraryIds")
                .evaluate()
                .then()
                .def()
                .hasNoErrors()
                ...
                .hasNoCriteriaReference()
                .up()
                .populationById("Denominator_1")
                .hasType(MeasurePopulationType.DENOMINATOR)
                .hasCount(11)
                .hasNoCriteriaReference()
                .up()
                .populationById("Numerator_1")
                .hasType(MeasurePopulationType.NUMERATOR)
                .hasCount(2)
                .hasNoCriteriaReference()
                .up()
                .populationById("DenomExcl_1")
                .hasType(MeasurePopulationType.DENOMINATOREXCLUSION)
                .hasCount(2)
                .hasNoCriteriaReference()
                .up()
                .populationById("NumerExcl_1")
                .hasType(MeasurePopulationType.NUMERATOREXCLUSION)
                .hasCount(0)
                .hasNoCriteriaReference()
                .up()
                ...
                .hasAggregationResult(1050.0)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReference("Denominator_1")
                .up()
                .populationById("observation-num")
                .hasType(MeasurePopulationType.MEASUREOBSERVATION)
                .hasCount(2)
                .hasAggregationResult(150.0)
                .hasAggregateMethod(ContinuousVariableObservationAggregateMethod.SUM)
                .hasCriteriaReference("Numerator_1");
    }
}
