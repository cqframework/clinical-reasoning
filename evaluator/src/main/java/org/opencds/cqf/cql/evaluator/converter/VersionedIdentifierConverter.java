...
public class VersionedIdentifierConverter {
    ...
    /**
     * Converts an org.cqframework.cql.elm.execution.VersionedIdentifier to an
     ...
     */
    public static org.hl7.elm.r1.VersionedIdentifier toElmIdentifier(
            VersionedIdentifier versionedIdentifier) {
        if (versionedIdentifier == null) {
            return null;
        }

        return new org.hl7.elm.r1.VersionedIdentifier().withSystem(versionedIdentifier.getSystem())
                .withId(versionedIdentifier.getId()).withVersion(versionedIdentifier.getVersion());
    }

    /**
     * Converts an org.hl7.elm.r1.VersionedIdentifier to an
     ...
     */
    public static VersionedIdentifier toEngineIdentifier(
            org.hl7.elm.r1.VersionedIdentifier versionedIdentifier) {
        if (versionedIdentifier == null) {
            return null;
        }

        return new VersionedIdentifier().withSystem(versionedIdentifier.getSystem())
                .withId(versionedIdentifier.getId()).withVersion(versionedIdentifier.getVersion());
    }
}
