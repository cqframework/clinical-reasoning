...
import static org.opencds.cqf.cql.evaluator.fhir.util.Parameters.getPartsByName;
import static org.opencds.cqf.cql.evaluator.fhir.util.Parameters.newParameters;
import static org.opencds.cqf.cql.evaluator.fhir.util.Parameters.newPart;
...
class ParametersTest {
    ...
    void testStu3Parameters() {
        ...
        parameters = newParameters(fhirContext,
                new org.hl7.fhir.dstu3.model.IdType("stu3ParameterIdType"));
    ...
    void testStu3ParametersPartName() {
        ...
        IBaseParameters parameters =
                newParameters(fhirContext, newPart(fhirContext, "stu3ParameterName"));
        assertTrue(parameters instanceof org.hl7.fhir.dstu3.model.Parameters);
        org.hl7.fhir.dstu3.model.Parameters stu3Parameters =
    ...
    void testR4Parameters() {
        ...
        parameters =
                newParameters(fhirContext, new org.hl7.fhir.r4.model.IdType("r4ParameterIdType"));
    ...
    void testR4ParametersPartName() {
        FhirContext fhirContext = FhirContext.forR4Cached();
        IBaseParameters parameters =
                newParameters(fhirContext, newPart(fhirContext, "r4ParameterName"));
        assertTrue(parameters instanceof org.hl7.fhir.r4.model.Parameters);
        org.hl7.fhir.r4.model.Parameters r4Parameters =
    ...
    void testR5Parameters() {
        ...
        parameters =
                newParameters(fhirContext, new org.hl7.fhir.r5.model.IdType("r5ParameterIdType"));
    ...
    void testR5ParametersPartName() {
        FhirContext fhirContext = FhirContext.forR5Cached();
        IBaseParameters parameters =
                newParameters(fhirContext, newPart(fhirContext, "r5ParameterName"));
        assertTrue(parameters instanceof org.hl7.fhir.r5.model.Parameters);
    ...
    void getPartsByNameTest() {
        FhirContext fhirContext = FhirContext.forR5Cached();
        IBaseParameters parameters = newParameters(fhirContext,
                newPart(fhirContext, "r5ParameterName"), newPart(fhirContext, "r5ParameterName1"),
