...
public class BundleBuilder<T extends IBaseBundle> extends ResourceBuilder<BundleBuilder<T>, T> {
  ...
  protected void initializeDstu2(T theResource) {
    ...
    ca.uhn.fhir.model.dstu2.resource.Bundle bundle =
        (ca.uhn.fhir.model.dstu2.resource.Bundle) theResource;
  ...
  protected void initializeDstu2_1(T theResource) {
    ...
    org.hl7.fhir.dstu2016may.model.Bundle bundle =
        (org.hl7.fhir.dstu2016may.model.Bundle) theResource;
  ...
  protected void initializeR4(T theResource) {
    ...
    bundle.setIdentifier(new org.hl7.fhir.r4.model.Identifier().setSystem(getIdentifier().getKey())
  ...
  protected void initializeR5(T theResource) {
    ...
    bundle.setIdentifier(new org.hl7.fhir.r5.model.Identifier().setSystem(getIdentifier().getKey())
        .setValue(getIdentifier().getValue()));
