...
public abstract class DomainResourceBuilder<SELF, T extends IDomainResource>
    ...
    protected void initializeDstu2(T theResource) {
        ...
        getExtensions().forEach(extensionSetting -> extensionSetting.getValue().getCodingSettings()
                .forEach(coding -> {
                    ca.uhn.fhir.model.dstu2.composite.CodeableConceptDt codeableConcept =
                            new ca.uhn.fhir.model.dstu2.composite.CodeableConceptDt()
                                    .addCoding(new ca.uhn.fhir.model.dstu2.composite.CodingDt()
                                            .setSystem(coding.getSystem()).setCode(coding.getCode())
        ...
        getModifierExtensions().forEach(extensionSetting -> extensionSetting.getValue()
                .getCodingSettings().forEach(coding -> {
                    ca.uhn.fhir.model.dstu2.composite.CodeableConceptDt codeableConcept =
                            new ca.uhn.fhir.model.dstu2.composite.CodeableConceptDt()
                                    .addCoding(new ca.uhn.fhir.model.dstu2.composite.CodingDt()
                                            .setSystem(coding.getSystem()).setCode(coding.getCode())
