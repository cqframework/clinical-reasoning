...
//         final PopulateRequest request = newPopulateRequestForVersion(FhirVersionEnum.R4, libraryEngine,
// questionnaire);
...
//                     final
// List<org.hl7.fhir.dstu3.model.QuestionnaireResponse.QuestionnaireResponseItemAnswerComponent>
...
//             case R5:
//                 var r5Item =
//                         (org.hl7.fhir.r5.model.QuestionnaireResponse.QuestionnaireResponseItemComponent)
// responseItem;
...
//         final Extension extension = new Extension(Constants.QUESTIONNAIRE_RESPONSE_AUTHOR, new
// StringType("theAuthor"));
//         questionnaireItemComponent.addExtension(extension);
//         // execute
//         final QuestionnaireResponseItemComponent actual =
//                 (QuestionnaireResponseItemComponent) fixture.processResponseItem(request,
