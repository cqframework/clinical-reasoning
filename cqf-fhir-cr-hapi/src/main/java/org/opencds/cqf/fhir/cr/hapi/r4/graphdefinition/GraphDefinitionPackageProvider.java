...
public class GraphDefinitionPackageProvider {
    ...
    public IBaseBundle packageGraphDefinition(
        ...
        return graphDefinitionProcessorFactory
                ...
                .packageGraphDefinition(Eithers.for3(canonicalType, id, null), params);
    }
    ...
    public IBaseBundle packageGraphDefinition(
            ...
            RequestDetails requestDetails)
            throws InternalErrorException, FHIRException {
        var idToUse = getIdType(fhirVersion, "GraphDefinition", id);
        var canonicalType = getCanonicalType(fhirVersion, canonical, url, version);
        var terminologyEndpointParam = getEndpoint(fhirVersion, terminologyEndpoint);
        var params = packageParameters(
                fhirVersion, terminologyEndpointParam, usePut == null ? Boolean.FALSE : usePut.booleanValue());
        return graphDefinitionProcessorFactory
                .create(requestDetails)
                .packageGraphDefinition(Eithers.for3(canonicalType, idToUse, null), params);
    }
}
