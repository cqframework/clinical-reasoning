...
public class FileDataProviderBuilder {
    ...
    private DataProvider getFhirProvider(String version, String uri) {
        ...
        if (versionEnum.isOlderThan(FhirVersionEnum.DSTU2)) {
            throw new NotImplementedException("Sorry there is no File Data Provider implementation for anything older than DSTU2 as of now.");
        }
            ...
            throw new NotImplementedException("Sorry there is no File Data Provider implementation for anything newer than or equal to R5 as of now.");
        }
        else {
