    ...
    private IBaseResource loadTestResources(String location) {
        ...
        if (resource.fhirType().equals("Library")) {
            ...
            switch (fhirContext.getVersion().getVersion()) {
                case DSTU3:
                    cqlLocation = org.opencds.cqf.cql.evaluator.fhir.util.dstu3.AttachmentUtil
                            .getCqlLocation(resource);
                    if (cqlLocation != null) {
                    ...
                    break;
                case R4:
                    cqlLocation = org.opencds.cqf.cql.evaluator.fhir.util.r4.AttachmentUtil
                            .getCqlLocation(resource);
                    if (cqlLocation != null) {
                        resource = org.opencds.cqf.cql.evaluator.fhir.util.r4.AttachmentUtil
                                .addData(resource, getCqlContent(cqlLocation));
                    }
                    break;
                case R5:
                    cqlLocation = org.opencds.cqf.cql.evaluator.fhir.util.r5.AttachmentUtil
                            .getCqlLocation(resource);
                    if (cqlLocation != null) {
                        resource = org.opencds.cqf.cql.evaluator.fhir.util.r5.AttachmentUtil
                                .addData(resource, getCqlContent(cqlLocation));
                    }
                    break;
                default:
