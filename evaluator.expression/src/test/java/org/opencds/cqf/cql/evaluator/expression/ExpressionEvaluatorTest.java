...
public class ExpressionEvaluatorTest {
  ...
  public void testSimpleExpressionEvaluate() {
    ...
    Parameters actual = (Parameters) evaluator.evaluate("1 + 3", null, null, null, null, null, null,
        null, null, null);
  ...
  public void testIncludedLibraryExpressionEvaluateWithBundle() {
    ...
    Parameters actual = (Parameters) evaluator.evaluate("not \"EXM125\".\"Numerator\"", null, null,
        Arrays.asList(library), null, bundle, null, endpoint, null, endpoint);
    assertTrue(expected.equalsDeep(actual));
  }
  ...
  public void testIncludedLibraryExpressionEvaluateWithoutBundle() {
    ...
    Pair<String, String> library =
        Pair.of("http://localhost/fhir/Library/EXM125|8.0.000", "EXM125");
    Parameters actual = (Parameters) evaluator.evaluate("not \"EXM125\".\"Numerator\"", null, null,
        Arrays.asList(library), null, null, null, endpoint, endpoint, endpoint);
    assertTrue(expected.equalsDeep(actual));
  }
  ...
  public void testFhirPathConstantList() {
    ...
    Parameters actual = (Parameters) evaluator.evaluate("%encounters.count()", input, null, null,
  ...
  public void testEmptyListExists() {
    ...
    Parameters actual = (Parameters) evaluator.evaluate("%encounters.exists()", input, null, null,
        null, null, null, null, null, null);
    assertTrue(expected.equalsDeep(actual));
  }
  ...
  public void testMultipleParameters() {
    ...
    Parameters actual =
        (Parameters) evaluator.evaluate("%encounters.count() > 1 and not IsNull(%procedure)", input,
  ...
  public void testTypeExtension() {
    ...
    ppc.addExtension("http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-parameterDefinition",
        new ParameterDefinition().setMax("1").setName("%measurereport").setType("MeasureReport"));
