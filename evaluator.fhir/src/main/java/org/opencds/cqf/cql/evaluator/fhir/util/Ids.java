...
public class Ids {
     ...
     * @return the id
     */
    public static <IdType extends IIdType> IdType newId(FhirContext theFhirContext,
            String theResourceType, String theId) {
     ...
     * @return the id
     */
    public static <IdType extends IIdType> IdType newId(FhirVersionEnum theFhirVersionEnum,
            String theResourceType, String theIdPart) {
        ...
        switch (theFhirVersionEnum) {
            ...
            default:
                throw new IllegalArgumentException(
                        String.format("newId does not support FHIR version %s",
