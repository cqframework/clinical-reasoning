...
public class ScoringTypePopulations {

    private ScoringTypePopulations() {}
    ...
    public enum PROPORTION_ALLOWED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.PROPORTION_ALLOWED> data = EnumSet.allOf(PROPORTION_ALLOWED.class);
    ...
    public enum PROPORTION_REQUIRED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.PROPORTION_REQUIRED> data = EnumSet.allOf(PROPORTION_REQUIRED.class);
    ...
    public enum RATIO_ALLOWED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.RATIO_ALLOWED> data = EnumSet.allOf(RATIO_ALLOWED.class);
    ...
    public enum RATIO_REQUIRED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.RATIO_REQUIRED> data = EnumSet.allOf(RATIO_REQUIRED.class);
    ...
    public enum CONTINUOUS_VARIABLE_ALLOWED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.CONTINUOUS_VARIABLE_ALLOWED> data =
    ...
    public enum CONTINUOUS_VARIABLE_REQUIRED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.CONTINUOUS_VARIABLE_REQUIRED> data =
    ...
    public enum COHORT_ALLOWED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.COHORT_ALLOWED> data = EnumSet.allOf(COHORT_ALLOWED.class);
    ...
    public enum COHORT_REQUIRED {
        ...
        public static Set<MeasurePopulationType> getPopulations() {
            EnumSet<ScoringTypePopulations.COHORT_REQUIRED> data = EnumSet.allOf(COHORT_REQUIRED.class);
