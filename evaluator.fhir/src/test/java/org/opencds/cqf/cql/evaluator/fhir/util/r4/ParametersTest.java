...
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.base64BinaryPart;
...
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.dateTimePart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.decimalPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.getPartsByName;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.idPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.instantPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.integerPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.markdownPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.oidPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.parameters;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.positiveIntPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.stringPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.timePart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.unsignedIntPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.uriPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.urlPart;
import static org.opencds.cqf.cql.evaluator.fhir.util.r4.Parameters.uuidPart;
...
class ParametersTest {
  ...
  void testParametersPartTypes() {
    org.hl7.fhir.r4.model.Parameters parameters =
        parameters(base64BinaryPart("r4Base64BinaryPart", "SGVsbG8gV29ybGQh"),
            booleanPart("r4BooleanPart", true),
            canonicalPart("r4CanonicalPart", "https://example.com/Library/example-library"),
            codePart("r4CodePart", "active"), datePart("r4DatePart", "2012-12-31"),
            dateTimePart("r4DateTimePart", "2015-02-07T13:28:17-05:00"),
            decimalPart("r4DecimalPart", 72.42), idPart("r4IdPart", "example-id"),
            instantPart("r4InstantPart", "2015-02-07T13:28:17.239+02:00"),
            integerPart("r4IntegerPart", 72), markdownPart("r4MarkdownPart", "## Markdown Title"),
            oidPart("r4OidPart", "urn:oid:1.2.3.4.5"), positiveIntPart("r4PositiveIntPart", 1),
            stringPart("r4StringPart", "example string"), timePart("r4TimePart", "12:30:30.500"),
  ...
  void getParameterByNameTest() {
    ...
    List<org.hl7.fhir.r4.model.Parameters.ParametersParameterComponent> parts =
