...
public class PrePopulateItemWithExtension {
    ...
    protected List<QuestionnaireItemComponent> processItem(
        ...
        QuestionnaireItemComponent theQuestionnaireGroupItem
        ...
        final List<IBase> populationContext = myExpressionProcessorService.getExpressionResult(
            ...
            contextExpression,
            theQuestionnaireGroupItem.getLinkId()
        );
    ...
    protected QuestionnaireItemComponent processPopulationContext(QuestionnaireItemComponent theQuestionnaireGroupItem, IBase theContext) {
    ...
    protected QuestionnaireItemComponent createNewQuestionnaireItemComponent(QuestionnaireItemComponent theQuestionnaireItemComponent, IBase theContext) {
