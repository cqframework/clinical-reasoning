...
public class KnowledgeArtifactPackageVisitor {
    ...
    public KnowledgeArtifactPackageVisitor() {
        this.terminologyServerClient = new TerminologyServerClient(FhirContext.forR5());
    }
    ...
    private void checkIfValueSetNeedsCondition(
        ...
        if (resource == null
            ...
            List<MetadataResource> searchResults =
                    getResourcesFromBundle(searchResourceByUrl(relatedArtifact.getResource(), repository));
