...
public class VersionedIdentifierConverterTests {
  ...
  public void toElmIdentifierTest() {
    ...
    org.hl7.elm.r1.VersionedIdentifier expected =
        new org.hl7.elm.r1.VersionedIdentifier().withId("1").withSystem("2").withVersion("3");
  ...
  public void toEngineIdentifierTest() {
    org.hl7.elm.r1.VersionedIdentifier test =
        new org.hl7.elm.r1.VersionedIdentifier().withId("1").withSystem("2").withVersion("3");
