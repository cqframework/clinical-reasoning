...
public class MinimalMeasureEvaluationTest {
    ...
    void ProportionBooleanBasisSingleGroup_Population() {
        ...
        // ** When subject meets criteria of Denominator Exception, but not Numerator, it shows count for Denominator Exception, removes count from Denominator
        // ** When subject meets criteria of Denominator Exception, and also Numerator, it shows count for Denominator/Numerator
    ...
    void ProportionBooleanBasisSingleGroup_Error_MissingRequiredPopulation() {
        var when = GIVEN_REPO
            ...
            .periodEnd("2024-12-31")
            .evaluate();
        // `Initial Population`, `Numerator`, `Denominator` are required Population Definitions for Measure Scoring Type: proportion
    ...
    void ContinuousVariableBooleanBasisSingleGroup_Error_MissingRequiredPopulation() {
        var when = GIVEN_REPO
            ...
            .periodEnd("2024-12-31")
            .evaluate();
        //`Initial Population` & `Measure Population` are required Population Definitions for Measure Scoring Type: continuous-variable
        assertThrows(NullPointerException.class, ()-> when.then().report());
    }
}
