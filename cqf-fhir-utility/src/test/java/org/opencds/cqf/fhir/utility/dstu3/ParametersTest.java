...
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.base64BinaryPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.booleanPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.codePart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.datePart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.dateTimePart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.decimalPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.getPartsByName;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.idPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.instantPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.integerPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.oidPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.parameters;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.positiveIntPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.stringPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.timePart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.unsignedIntPart;
import static org.opencds.cqf.fhir.utility.dstu3.Parameters.uriPart;
...
class ParametersTest {
  ...
  void testParametersPartTypes() {
    org.hl7.fhir.dstu3.model.Parameters parameters = parameters(
        ...
        positiveIntPart("stu3PositiveIntPart", 1), stringPart("stu3StringPart", "example string"),
    ...
    for (org.hl7.fhir.dstu3.model.Parameters.ParametersParameterComponent stu3Component : parameters
      ...
      if (stu3Component.getName().equals("stu3Base64BinaryPart")) {
        ...
        assertEquals("2015-02-07T13:28:17.239+02:00",
            ((InstantType) stu3Component.getValue()).getValueAsString());
        ...
        assertEquals("news:comp.infosystems.www.servers.unix",
            ((UriType) stu3Component.getValue()).getValueAsString());
      }
    }
  }
  ...
  void getParameterByNameTest() {
    org.hl7.fhir.dstu3.model.Parameters parameters =
