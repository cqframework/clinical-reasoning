...
public class NewQuestionnaireResponseProcessor extends BaseQuestionnaireResponseProcessor<QuestionnaireResponse> {
    Processor processor;

    public NewQuestionnaireResponseProcessor(Repository repository) {
        this(repository, EvaluationSettings.getDefault());
    }

    public NewQuestionnaireResponseProcessor(Repository repository, EvaluationSettings evaluationSettings) {
    ...
    public List<IBaseResource> processItems(QuestionnaireResponse questionnaireResponse) {
        return processor.processItems(questionnaireResponse);
    }
}
