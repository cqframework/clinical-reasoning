  ...
  public void measure_eval_non_retrieve_resource() {
    ...
    assertThrows(ResourceNotFoundException.class,
        () -> this.measureProcessor.evaluateMeasure(
            ...
            "2022-12-31", "subject", "Patient/hist-open-HCC189", null, null, endpoint, endpoint,
            endpoint, null));

    MeasureReport report = this.measureProcessor.evaluateMeasure(
        "https://build.fhir.org/ig/HL7/davinci-ra/ConditionCategoryPOC", "2022-01-01", "2022-12-31",
        "subject", "Patient/hist-closed-HCC189", null, null, endpoint, endpoint, endpoint, null);
    ...
    assertEquals(report.getExtension().stream()
        .filter(item -> item.getValue().getClass() == Reference.class
