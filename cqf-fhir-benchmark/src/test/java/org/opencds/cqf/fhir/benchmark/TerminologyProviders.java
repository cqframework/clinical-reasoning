...
public class TerminologyProviders {
  ...
  private static final Code smallCode = new Code()
      .withCode("F")
      .withSystem("http://terminology.hl7.org/CodeSystem/v3-AdministrativeGender");
  ...
  private static final Code largeCode = new Code()
      .withCode("199246")
      .withSystem("http://www.nlm.nih.gov/research/umls/rxnorm");
  ...
  public void setupIteration() throws Exception {
    var repository = TestRepositoryFactory.createRepository(FhirContext.forR4Cached(),
        MeasureProcessorEvaluateTest.class, "CaseRepresentation101");
