...
public class CdsCrServiceR5 implements ICdsCrService {
    ...
    public CdsCrServiceR5(RequestDetails requestDetails, Repository repository, ICdsConfigService cdsConfigService) {
    ...
    protected CdsServiceResponseCardJson resolveAction(
            RequestOrchestration.RequestOrchestrationActionComponent action, List<CdsServiceResponseLinkJson> links) {
    ...
    protected void resolveSystemAction(RequestOrchestration.RequestOrchestrationActionComponent action) {
        if (action.hasType()
