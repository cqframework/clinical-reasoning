...
/**
 * This enum represents the values defined inline for the reportType parameter
 * of the Measure $evaluate-measure operation.
 *
 * The values currently (as of R4) aren't bound to the same ValueSet as the
 * MeasureReport type so that's why this is defined
 * separately. The intent is that they will bound to the same ValueSet in the
 * future.
 */
