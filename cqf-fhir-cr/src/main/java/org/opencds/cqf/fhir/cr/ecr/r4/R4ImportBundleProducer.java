...
public class R4ImportBundleProducer {
	...
	public static List<Bundle.BundleEntryComponent> transformImportBundle(Bundle parameterBundle, IRepository repository, String appAuthoritativeUrl) throws FhirResourceExistsException {
