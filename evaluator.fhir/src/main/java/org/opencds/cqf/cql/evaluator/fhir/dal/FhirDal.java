...
public interface FhirDal {
    /**
     * Fetches an {@code IBaseResource} by {@code id}. The {@code IIdType} must have the
     * resourceType defined.
     *
    ...
    /**
     * Deletes an {@code IBaseResource} by {@code id}. The {@code IIdType} must have the
     * resourceType defined.
     *
