...
public class ActivityDefinitionProcessor extends BaseActivityDefinitionProcessor<ActivityDefinition> {
    ...
    protected <C extends IPrimitiveType<String>> ActivityDefinition resolveActivityDefinition(
        ...
        if (baseActivityDefinition == null) {
            baseActivityDefinition = d != null
                    ? this.repository.read(ActivityDefinition.class, d)
    ...
    protected IBaseResource applyActivityDefinition(ActivityDefinition activityDefinition) {
        ...
        try {
            result = (DomainResource) Class.forName("org.hl7.fhir.r4.model."
        ...
        for (var dynamicValue : activityDefinition.getDynamicValue()) {
            if (dynamicValue.hasExpression()) {
                ...
                var expressionResult = libraryEngine.resolveExpression(
                        ...
                        inputParams,
                        bundle);
                resolveDynamicValue(expressionResult, expression.getExpression(), dynamicValue.getPath(), result);
            }
        }
    ...
    private void resolveExtensions(
            DomainResource resource, ActivityDefinition activityDefinition, String defaultLibraryUrl) {
    ...
    private Task resolveTask(ActivityDefinition activityDefinition) {
        ...
        if (activityDefinition.hasExtension(BaseActivityDefinitionProcessor.TARGET_STATUS_URL)) {
            ...
            if (value instanceof StringType) {
                ...
                logger.debug(
                        "Extension {} should have a value of type {}",
