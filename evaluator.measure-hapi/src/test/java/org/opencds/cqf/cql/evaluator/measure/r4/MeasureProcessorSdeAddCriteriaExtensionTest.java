...
public class MeasureProcessorSdeAddCriteriaExtensionTest extends BaseMeasureProcessorTest {
    ...
    public void exm124_subject_list() {
        MeasureReport report = this.measureProcessor.evaluateMeasure(
                "http://nhsnlink.org/fhir/Measure/InitialInpatientPopulation", "2019-01-01",
                "2020-01-01", "subject", "Patient/97f27374-8a5c-4aa1-a26f-5a1ab03caa47", null, null,
        ...
        assertEquals(population.get().getCount(), expectedCount, String
