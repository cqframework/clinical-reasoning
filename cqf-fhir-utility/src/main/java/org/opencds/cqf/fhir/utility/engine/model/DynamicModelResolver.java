...
public class DynamicModelResolver extends CachingModelResolverDecorator {
  protected static final Logger logger =
      LoggerFactory.getLogger(DynamicModelResolver.class);
  ...
  protected BaseRuntimeElementCompositeDefinition<?> resolveRuntimeDefinition(IBase base) {
    if (base instanceof IAnyResource) {
      ...
      return (BaseRuntimeElementCompositeDefinition<?>) fhirContext
          .getElementDefinition(base.getClass());
    } else if (base instanceof ICompositeType) {
      return (BaseRuntimeElementCompositeDefinition<ICompositeType>) fhirContext
          .getElementDefinition(base.getClass());
    }

    throw new UnknownType(
        String.format("Unable to resolve the runtime definition for %s",
    ...
    switch (fhirContext.getVersion().getVersion()) {
      case DSTU3:
        return (E) new org.hl7.fhir.dstu3.model.Enumeration(
            (org.hl7.fhir.dstu3.model.EnumFactory<Enum<?>>) toEnumFactory(
                targetDef.getBoundEnumType()),
            value);
      case R4:
        return (E) new org.hl7.fhir.r4.model.Enumeration(
            (org.hl7.fhir.r4.model.EnumFactory<Enum<?>>) toEnumFactory(
                targetDef.getBoundEnumType()),
            value);
      case R5:
        return (E) new org.hl7.fhir.r5.model.Enumeration(
            (org.hl7.fhir.r5.model.EnumFactory<Enum<?>>) toEnumFactory(
                targetDef.getBoundEnumType()),
            value);
