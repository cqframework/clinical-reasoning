...
class ParametersTest {
  ...
  void testStu3Parameters() {
    ...
    parameters =
        newParameters(fhirContext, new org.hl7.fhir.dstu3.model.IdType("stu3ParameterIdType"));
  ...
  void getPartsByNameTest() {
    ...
    IBaseParameters parameters = newParameters(fhirContext, newPart(fhirContext, "r5ParameterName"),
        newPart(fhirContext, "r5ParameterName1"), newPart(fhirContext, "r5ParameterName1"));
