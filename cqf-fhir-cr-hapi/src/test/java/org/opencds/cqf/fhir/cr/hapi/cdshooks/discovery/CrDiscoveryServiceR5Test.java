...
class CrDiscoveryServiceR5Test extends BaseCdsCrDiscoveryServiceTest {
    ...
    private static final DataRequirement DATA_REQUIREMENT_PATIENT = new DataRequirement()
        .setType(FHIRTypes.PATIENT);
    private static final DataRequirement DATA_REQUIREMENT_ENCOUNTER = new DataRequirement()
