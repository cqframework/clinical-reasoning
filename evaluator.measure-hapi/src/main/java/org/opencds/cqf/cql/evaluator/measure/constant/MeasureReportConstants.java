package org.opencds.cqf.cql.evaluator.measure.constant;
...
public class MeasureReportConstants {
  ...
  public static final Date MEASUREREPORT_SUPPLEMENTALDATA_SEARCHPARAMETER_DEFINITION_DATE = Date.valueOf("2022-07-20"); //issue without local date?
