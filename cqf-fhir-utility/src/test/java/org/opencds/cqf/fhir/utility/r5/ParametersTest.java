...
import static org.opencds.cqf.fhir.utility.r5.Parameters.base64BinaryPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.booleanPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.canonicalPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.codePart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.datePart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.dateTimePart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.decimalPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.getPartsByName;
import static org.opencds.cqf.fhir.utility.r5.Parameters.idPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.instantPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.integer64Part;
import static org.opencds.cqf.fhir.utility.r5.Parameters.integerPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.markdownPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.oidPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.parameters;
import static org.opencds.cqf.fhir.utility.r5.Parameters.positiveIntPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.stringPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.timePart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.unsignedIntPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.uriPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.urlPart;
import static org.opencds.cqf.fhir.utility.r5.Parameters.uuidPart;
...
class ParametersTest {
    ...
    void testParametersPartTypes() {
        ...
        assertEquals(
                "https://example.com/Library/example-library",
        ...
        assertEquals((Long) 9223372036854775807L, ((org.hl7.fhir.r5.model.Integer64Type) r5Type).getValue());
        ...
        assertEquals(
                "s:comp.infosystems.www.servers.unix", ((org.hl7.fhir.r5.model.UriType) r5Type).getValueAsString());
