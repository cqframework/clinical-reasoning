...
class PopulationDefTest {
    ...
    //        assertFalse(popDef2.isBooleanBasis());
    //
    //        final Encounter enc1a = (Encounter) new Encounter().setId(new IdType(ResourceType.Encounter.name(),
    // "enc1"));
    //        final Encounter enc1b = (Encounter) new Encounter().setId(new IdType(ResourceType.Encounter.name(),
    // "enc1"));
    //
    ...
    // null);
    //        assertFalse(encounterPop.isBooleanBasis(), "Expected isBooleanBasis() to return false for Encounter
    // basis");
    //
    //        CodeDef stringBasis = new CodeDef("http://hl7.org/fhir/fhir-types", "String");
    ...
    //                new PopulationDef("pop-2", null, MeasurePopulationType.DENOMINATOR, "Denominator", booleanBasis,
    // null);
    //
    ...
    //        assertTrue(
    //                getResourcesDistinctAcrossAllSubjects(popDef1).contains(enc1), "Encounter/1 should remain in
    // popDef1");
    //    }
    //
    //    /**
    ...
    //                "pop-1", null, MeasurePopulationType.INITIALPOPULATION, "InitialPopulation", booleanBasis, null);
    //        PopulationDef popDef2 = new PopulationDef(
    //                "pop-2", null, MeasurePopulationType.DENOMINATOREXCLUSION, "DenominatorExclusion", booleanBasis,
    // null);
    //
    //        // popDef1 has subjects 1, 2, 3
    //        popDef1.addResource("Patient/1", true);
