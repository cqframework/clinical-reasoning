...
/**
 * DSTU3-specific implementation of IMeasureReportScoringFhirAdapter.
 *
 ...
 */
public record Dstu3MeasureReportScoringFhirAdapter(MeasureDefScorer measureDefScorer)
    ...
    public MeasureDef buildMeasureDef(Measure measure) {
        var builder = new org.opencds.cqf.fhir.cr.measure.dstu3.Dstu3MeasureDefBuilder();
