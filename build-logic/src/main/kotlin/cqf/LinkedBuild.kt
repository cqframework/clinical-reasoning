 ...
 * @param substitutions map of Maven module coordinate to Gradle project path. All consumed modules
 *   must be listed — providing any explicit substitution disables Gradle's automatic substitution
 *   for the entire included build.
 */
...
/**
 * Registry of all known linked builds. Add new repos here — both the settings plugin (includeBuild)
 * and the CI plugin (resolveLinkedBuilds) read from this list.
 */
object LinkedBuildRegistry {

    private val CQL_ENGINE =
        LinkedBuild(
