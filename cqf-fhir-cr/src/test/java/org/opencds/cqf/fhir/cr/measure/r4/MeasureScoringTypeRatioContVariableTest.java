...
class MeasureScoringTypeRatioContVariableTest {
    ...
    // LUKETODO:  ensure .hasNoAggregationResult() for all defs
    // LUKETODO:  ensure .hasNoAggregationResultsExtensionValue() for all defs
    ...
    void ratioContinuousVariableStratifierResource() {
        given.when()
                ...
                .up()
                // LUKETODO: observation-num
                // LUKETODO: observation-den
                .up()
                .stratumByValue("F")
