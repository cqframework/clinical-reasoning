...
public interface TerminologyProviderFactory {
  /**
   * Returns a TerminologyProvider for the given endpointInfo. Returns null if endpointInfo is null.
   *
  ...
  /**
   * Returns a TerminologyProvider for the given Bundle. Returns null if terminologyBundle is null.
   *
