...
public class Parameters {
   ...
   */
  public static IBaseParameters newParameters(FhirContext fhirContext, IIdType theId,
      IBase... parts) {
    checkNotNull(theId);
  ...
  public static IBaseParameters newParameters(FhirContext fhirContext, String theId,
      IBase... parts) {
    checkNotNull(theId);
    IIdType id =
        (IIdType) Objects.requireNonNull(fhirContext.getElementDefinition("id")).newInstance();
    id.setValue(theId);
  ...
  public static IBase newPart(FhirContext fhirContext, String name, IBase... parts) {
    ...
    IBase theName =
        Objects.requireNonNull(fhirContext.getElementDefinition("string")).newInstance(name);
   ...
   * @return new parameter Part
   */
  public static IBase newPart(FhirContext fhirContext, String typeName, String name, Object value,
      IBase... parts) {
    validateNameAndValue(name, value);
    IBase newPpc = newPart(fhirContext, name, parts);
   ...
   * @return new parameter Part
   */
  public static IBase newPart(FhirContext fhirContext, String name, IBaseResource value,
      IBase... parts) {
    validateNameAndValue(name, value);
    IBase newPpc = newPart(fhirContext, name, parts);
    getParameterElement(fhirContext).getChildByName("resource").getMutator().setValue(newPpc,
        value);
    return newPpc;
  }
   ...
   */
  public static Optional<String> getSingularStringPart(FhirContext fhirContext,
      IBaseResource parameters, String name) {
    checkNotNull(parameters);
    checkNotNull(name);
    return ParametersUtil.getNamedParameterValueAsString(fhirContext, (IBaseParameters) parameters,
        name);
  }
   ...
   * @return parameter string name
   */
  public static List<IBase> getPartsByName(FhirContext fhirContext, IBaseResource parameters,
      String name) {
    checkNotNull(parameters);
    checkNotNull(name);
   ...
   */
  public static IBase newBase64BinaryPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newBooleanPart(FhirContext fhirContext, String name, boolean value,
      IBase... parts) {
   ...
   */
  public static IBase newCanonicalPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newCodePart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newDatePart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newDateTimePart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newDecimalPart(FhirContext fhirContext, String name, double value,
      IBase... parts) {
   ...
   * @return new ID part
   */
  public static IBase newIdPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newInstantPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newIntegerPart(FhirContext fhirContext, String name, int value,
      IBase... parts) {
   ...
   */
  public static IBase newInteger64Part(FhirContext fhirContext, String name, long value,
      IBase... parts) {
   ...
   */
  public static IBase newMarkdownPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   * @return new OID part
   */
  public static IBase newOidPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newPositiveIntPart(FhirContext fhirContext, String name, int value,
      IBase... parts) {
   ...
   */
  public static IBase newStringPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newTimePart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newUnsignedIntPart(FhirContext fhirContext, String name, int value,
      IBase... parts) {
   ...
   * @return new uri part
   */
  public static IBase newUriPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   * @return new url part
   */
  public static IBase newUrlPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
   ...
   */
  public static IBase newUuidPart(FhirContext fhirContext, String name, String value,
      IBase... parts) {
