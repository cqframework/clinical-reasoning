...
public class LibraryEvaluator implements org.opencds.cqf.cql.evaluator.library.LibraryEvaluator {
    ...
    @Inject
    public LibraryEvaluator(FhirContext fhirContext, AdapterFactory adapterFactory, LibraryLoaderFactory libraryLoaderFactory,
