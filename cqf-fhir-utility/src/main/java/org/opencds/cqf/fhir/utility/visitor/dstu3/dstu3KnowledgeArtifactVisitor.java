...
public interface dstu3KnowledgeArtifactVisitor extends KnowledgeArtifactVisitor{
  ...
  IBase visit(dstu3KnowledgeArtifactVisitor knowledgeArtifact, Repository theRepository, Parameters draftParameters);
  IBase visit(Dstu3LibraryAdapter library, Repository theRepository, Parameters draftParameters);
