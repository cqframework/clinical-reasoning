...
public class CompositionBuilder<T extends IDomainResource>
    ...
    public CompositionBuilder(Class<T> theResourceClass, String theId,
            CodeableConceptSettings theType, String theStatus, String theAuthor, String theTitle) {
    ...
    public CompositionBuilder<T> withAuthor(String theAuthor) {
        ...
        checkArgument(theAuthor.startsWith("Practitioner")
                || theAuthor.startsWith("PractitionerRole") || theAuthor.startsWith("Device")
                || theAuthor.startsWith("Patient") || theAuthor.startsWith("RelatedPerson")
    ...
    public T build() {
        ...
        checkArgument(
                !myType.getCodingSettings().isEmpty() && myType.getCodingSettings().size() == 1);
    ...
    protected void initializeDstu2(T theResource) {
        ...
        composition.setDate(new DateTimeDt(myDate))
                .setIdentifier(
                        new IdentifierDt(getIdentifier().getKey(), getIdentifier().getValue()))
                .setStatus(CompositionStatusEnum.forCode(myStatus))
                .setSubject(new ResourceReferenceDt(mySubject)).setTitle(myTitle)
                .setType(new CodeableConceptDt().addCoding(new CodingDt()
                        .setSystem(getTypeSetting().getSystem()).setCode(getTypeSetting().getCode())
                        .setDisplay(getTypeSetting().getDisplay())))
                .setAuthor(author).setCustodian(new ResourceReferenceDt(myCustodian));
    }
    ...
    protected void initializeDstu2_1(T theResource) {
        ...
        composition.setDate(myDate)
                .setIdentifier(new Identifier().setSystem(getIdentifier().getKey())
                        .setValue(getIdentifier().getValue()))
                .setStatus(org.hl7.fhir.dstu2016may.model.Composition.CompositionStatus
                        .valueOf(myStatus))
                .setSubject(new Reference(mySubject)).setTitle(myTitle)
                .setType(new CodeableConcept().addCoding(new Coding()
                        .setSystem(getTypeSetting().getSystem()).setCode(getTypeSetting().getCode())
                        .setDisplay(getTypeSetting().getDisplay())))
                .addAuthor(new Reference(myAuthor)).setCustodian(new Reference(myCustodian));
    }

    @Override
    protected void initializeDstu2_HL7Org(T theResource) {
        super.initializeDstu2_HL7Org(theResource);
        org.hl7.fhir.dstu2.model.Composition composition =
                (org.hl7.fhir.dstu2.model.Composition) theResource;
        ...
        composition.setDate(myDate)
                ...
                .setSubject(new org.hl7.fhir.dstu2.model.Reference(mySubject)).setTitle(myTitle)
    ...
    protected void initializeDstu3(T theResource) {
        ...
        org.hl7.fhir.dstu3.model.Composition composition =
                (org.hl7.fhir.dstu3.model.Composition) theResource;
        ...
        composition.setDate(myDate)
                ...
                .setSubject(new org.hl7.fhir.dstu3.model.Reference(mySubject)).setTitle(myTitle)
    ...
    protected void initializeR4(T theResource) {
        ...
        org.hl7.fhir.r4.model.Composition composition =
                (org.hl7.fhir.r4.model.Composition) theResource;
        ...
        composition.setDate(myDate)
                ...
                .setSubject(new org.hl7.fhir.r4.model.Reference(mySubject)).setTitle(myTitle)
                .setType(new org.hl7.fhir.r4.model.CodeableConcept().addCoding(
                        new org.hl7.fhir.r4.model.Coding().setSystem(getTypeSetting().getSystem())
                                .setCode(getTypeSetting().getCode())
                                .setDisplay(getTypeSetting().getDisplay())))
    ...
    protected void initializeR5(T theResource) {
        ...
        org.hl7.fhir.r5.model.Composition composition =
                (org.hl7.fhir.r5.model.Composition) theResource;
        ...
        r5Identifier.setSystem(getIdentifier().getKey()).setValue(getIdentifier().getValue());
        r5Identifiers.add(r5Identifier);
        List<org.hl7.fhir.r5.model.Reference> r5References = new ArrayList<>();
        org.hl7.fhir.r5.model.Reference r5Reference =
                new org.hl7.fhir.r5.model.Reference(mySubject);
        r5References.add(r5Reference);
        composition.setDate(myDate).setIdentifier(r5Identifiers)
                .setStatus(CompositionStatus.valueOf(myStatus)).setSubject(r5References)
                .setTitle(myTitle)
                .setType(new org.hl7.fhir.r5.model.CodeableConcept().addCoding(
                        new org.hl7.fhir.r5.model.Coding().setSystem(getTypeSetting().getSystem())
                                .setCode(getTypeSetting().getCode())
                                .setDisplay(getTypeSetting().getDisplay())))
