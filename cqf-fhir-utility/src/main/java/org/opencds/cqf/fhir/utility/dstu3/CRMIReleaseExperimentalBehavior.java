...
public class CRMIReleaseExperimentalBehavior {
    public enum CRMIReleaseExperimentalBehaviorCodes {
        ...
        public static CRMIReleaseExperimentalBehaviorCodes fromCode(String codeString) throws FHIRException {
            ...
            if ("error".equals(codeString)) return ERROR;
            if ("warn".equals(codeString)) return WARN;
            if ("none".equals(codeString)) return NONE;
            if (Configuration.isAcceptInvalidEnums()) return null;
            else throw new FHIRException("Unknown CRMIReleaseExperimentalBehaviorCode '" + codeString + "'");
        }
    ...
    public static class CRMIReleaseExperimentalBehaviorCodesEnumFactory
        ...
        public CRMIReleaseExperimentalBehaviorCodes fromCode(String codeString) throws IllegalArgumentException {
            if (codeString == null || "".equals(codeString))
                if (codeString == null || "".equals(codeString)) return null;
            if ("error".equals(codeString)) return CRMIReleaseExperimentalBehaviorCodes.ERROR;
            if ("warn".equals(codeString)) return CRMIReleaseExperimentalBehaviorCodes.WARN;
            if ("none".equals(codeString)) return CRMIReleaseExperimentalBehaviorCodes.NONE;
            throw new IllegalArgumentException(
                    "Unknown CRMIReleaseExperimentalBehaviorCodes code '" + codeString + "'");
        }
        ...
        public Enumeration<CRMIReleaseExperimentalBehaviorCodes> fromType(Base code) throws FHIRException {
            ...
            if ("error".equals(codeString))
                return new Enumeration<CRMIReleaseExperimentalBehaviorCodes>(
                        this, CRMIReleaseExperimentalBehaviorCodes.ERROR);
            if ("warn".equals(codeString))
                return new Enumeration<CRMIReleaseExperimentalBehaviorCodes>(
                        this, CRMIReleaseExperimentalBehaviorCodes.WARN);
            if ("none".equals(codeString))
                return new Enumeration<CRMIReleaseExperimentalBehaviorCodes>(
                        this, CRMIReleaseExperimentalBehaviorCodes.NONE);
        ...
        public String toCode(CRMIReleaseExperimentalBehaviorCodes code) {
            if (code == CRMIReleaseExperimentalBehaviorCodes.ERROR) return "error";
            if (code == CRMIReleaseExperimentalBehaviorCodes.WARN) return "warn";
            if (code == CRMIReleaseExperimentalBehaviorCodes.NONE) return "none";
            return "?";
        }
