...
public class PlanDefinitionProcessor extends BasePlanDefinitionProcessor<PlanDefinition> {
  ...
  public CarePlan transformToCarePlan(IBaseResource rg) {
    ...
    carePlan.addActivity().setPlannedActivityReference(new Reference("#" + requestGroup.getIdElement().getIdPart()));
  ...
  private void applyQuestionnaireDefinition(PlanDefinition planDefinition, RequestGroup requestGroup, CanonicalType definition, PlanDefinition.PlanDefinitionActionComponent action) {
  ...
  private void applyActivityDefinition(PlanDefinition planDefinition, RequestGroup requestGroup, CanonicalType definition,
      PlanDefinition.PlanDefinitionActionComponent action) {
    IBaseResource result;
    try {
      var referenceToContained = definition.getValue().startsWith("#");
  ...
  private void resolveDynamicActions(PlanDefinition planDefinition, RequestGroup requestGroup, PlanDefinition.PlanDefinitionActionComponent action) {
