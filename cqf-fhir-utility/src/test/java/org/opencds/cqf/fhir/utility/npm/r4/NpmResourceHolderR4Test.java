...
class NpmResourceHolderR4Test extends BaseNpmResourceInfoForCqlTest {
    ...
    void simpleAlpha() {
        ...
        verifyMeasure(optMeasure.orElse(null), MEASURE_URL_ALPHA, VERSION_0_1,
            LIBRARY_URL_ALPHA_WITH_VERSION);

        final Optional<Library> optLibrary =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_ALPHA_WITH_VERSION));

        verifyLibrary(optLibrary.orElse(null), LIBRARY_URL_ALPHA_NO_VERSION, VERSION_0_1,
            EXPECTED_CQL_ALPHA);
    ...
    void simpleBravo() {
        ...
        verifyMeasure(optMeasure.orElse(null), MEASURE_URL_BRAVO, VERSION_0_1,
            LIBRARY_URL_BRAVO_WITH_VERSION);

        final Optional<Library> optLibrary =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_BRAVO_WITH_VERSION));

        verifyLibrary(optLibrary.orElse(null), LIBRARY_URL_BRAVO_NO_VERSION, VERSION_0_1,
            EXPECTED_CQL_BRAVO);
    ...
    void multiplePackages() {
        final BaseNpmPackageLoaderInMemory loader = setup(Stream.of(SIMPLE_ALPHA_TGZ, SIMPLE_BRAVO_TGZ).map(Paths::get).toList());
        ...
        assertTrue(allNamespaceInfos.contains(
            new NamespaceInfo(SIMPLE_ALPHA_NAMESPACE, SIMPLE_ALPHA_NAMESPACE_URL)));
        assertTrue(allNamespaceInfos.contains(
            new NamespaceInfo(SIMPLE_BRAVO_NAMESPACE, SIMPLE_BRAVO_NAMESPACE_URL)));

        final Optional<Measure> optMeasureAlpha =
            loader.loadNpmResource(Measure.class, new CanonicalType(MEASURE_URL_ALPHA));

        verifyMeasure(optMeasureAlpha.orElse(null), MEASURE_URL_ALPHA, VERSION_0_1,
            LIBRARY_URL_ALPHA_WITH_VERSION);
        ...
        verifyLibrary(optLibraryAlpha.orElse(null), LIBRARY_URL_ALPHA_NO_VERSION, VERSION_0_1,
            EXPECTED_CQL_ALPHA);

        final Optional<Measure> optMeasureBravo =
            loader.loadNpmResource(Measure.class, new CanonicalType(MEASURE_URL_ALPHA));

        verifyMeasure(optMeasureBravo.orElse(null), MEASURE_URL_ALPHA, VERSION_0_1,
            LIBRARY_URL_ALPHA_WITH_VERSION);
        ...
        verifyLibrary(optLibraryBravo.orElse(null), LIBRARY_URL_BRAVO_NO_VERSION, VERSION_0_1,
            EXPECTED_CQL_BRAVO);
    }
    ...
    void derivedLibrary() {
        ...
        assertTrue(allNamespaceInfos.contains(
            new NamespaceInfo(WITH_DERIVED_NAMESPACE, WITH_DERIVED_URL)));

        final Optional<Measure> optMeasureWithDerived =
            loader.loadNpmResource(Measure.class,
                new CanonicalType(MEASURE_URL_WITH_DERIVED_LIBRARY));

        verifyMeasure(optMeasureWithDerived.orElse(null), MEASURE_URL_WITH_DERIVED_LIBRARY,
            VERSION_0_4, LIBRARY_URL_WITH_DERIVED_LIBRARY_WITH_VERSION);

        final Optional<Library> optLibraryWithDerived =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_WITH_DERIVED_LIBRARY_WITH_VERSION));
        ...
        verifyLibrary(
            optLibraryDerived.orElse(null),
            LIBRARY_URL_DERIVED_LIBRARY,
            VERSION_0_4,
            EXPECTED_CQL_DERIVED);
    }
    ...
    void derivedLibraryTwoLayers() {
        ...
        assertTrue(allNamespaceInfos.contains(new NamespaceInfo(WITH_TWO_LAYERS_NAMESPACE, WITH_TWO_LAYERS_DERIVED_URL)));

        final Optional<Measure> optMeasureWithTwoDerived =
            loader.loadNpmResource(Measure.class,
                new CanonicalType(MEASURE_URL_WITH_TWO_LAYERS_DERIVED_LIBRARIES));
        ...
        final Optional<Library> optLibraryWithTwoDerived =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_WITH_TWO_LAYERS_DERIVED_LIBRARIES_WITH_VERSION));
        ...
        final Optional<Library> optLibraryWithTwoDerived1a =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_WITH_TWO_LAYERS_DERIVED_LIBRARY_1A));
        ...
        final Optional<Library> optLibraryWithTwoDerived1b =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_WITH_TWO_LAYERS_DERIVED_LIBRARY_1B));
        ...
        final Optional<Library> optLibraryWithTwoDerived2a =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_WITH_TWO_LAYERS_DERIVED_LIBRARY_2A));
        ...
        final Optional<Library> optLibraryWithTwoDerived2b =
            loader.loadNpmResource(Library.class,
                new CanonicalType(LIBRARY_URL_WITH_TWO_LAYERS_DERIVED_LIBRARY_2B));
    ...
    void crossPackage() {
        ...
        assertTrue(allNamespaceInfos.contains(new NamespaceInfo(CROSS_PACKAGE_TARGET_NAMESPACE, CROSS_PACKAGE_TARGET_URL)));
    ...
    protected void verifyMeasure(@Nullable Measure measure, String measureUrl, String version, String expectedLibraryUrl) {
    ...
    private void verifyLibrary(@Nullable ILibraryAdapter libraryAdapter, String expectedLibraryUrl, String version, String expectedCql) {
    ...
    private void verifyLibrary(@Nullable Library library, String expectedLibraryUrl, String version, String expectedCql) {
    ...
    @Nonnull
    protected R4NpmPackageLoaderInMemory setup(List<Path> tgzPaths) {
