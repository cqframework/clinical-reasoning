...
class PlanDefinitionActionAdapterTest {
    ...
    void testTrigger() {
        ...
        var action = new PlanDefinition.PlanDefinitionActionComponent().addTriggerDefinition(trigger);
        var adapter = new PlanDefinitionActionAdapter(action);
    ...
    void testType() {
        ...
        var action = new PlanDefinition.PlanDefinitionActionComponent().setType(type.getCodingFirstRep());
        var adapter = new PlanDefinitionActionAdapter(action);
