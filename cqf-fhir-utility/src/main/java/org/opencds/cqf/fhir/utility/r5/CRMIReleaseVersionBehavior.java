...
public class CRMIReleaseVersionBehavior {
    public enum CRMIReleaseVersionBehaviorCodes {
        ...
        public static CRMIReleaseVersionBehaviorCodes fromCode(String codeString) throws FHIRException {
            ...
            if ("default".equals(codeString)) return DEFAULT;
            if ("check".equals(codeString)) return CHECK;
            if ("force".equals(codeString)) return FORCE;
            if (Configuration.isAcceptInvalidEnums()) return null;
            else throw new FHIRException("Unknown CRMIReleaseVersionBehaviorCodes '" + codeString + "'");
        }
    ...
    public static class CRMIReleaseVersionBehaviorCodesEnumFactory
        ...
        public CRMIReleaseVersionBehaviorCodes fromCode(String codeString) throws IllegalArgumentException {
            if (codeString == null || "".equals(codeString))
                if (codeString == null || "".equals(codeString)) return null;
            if ("default".equals(codeString)) return CRMIReleaseVersionBehaviorCodes.DEFAULT;
            if ("check".equals(codeString)) return CRMIReleaseVersionBehaviorCodes.CHECK;
            if ("force".equals(codeString)) return CRMIReleaseVersionBehaviorCodes.FORCE;
        ...
        public String toCode(CRMIReleaseVersionBehaviorCodes code) {
            if (code == CRMIReleaseVersionBehaviorCodes.DEFAULT) return "error";
            if (code == CRMIReleaseVersionBehaviorCodes.CHECK) return "check";
            if (code == CRMIReleaseVersionBehaviorCodes.FORCE) return "force";
            return "?";
        }
