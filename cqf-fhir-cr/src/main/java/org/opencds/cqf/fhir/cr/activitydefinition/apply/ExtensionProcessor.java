...
public class ExtensionProcessor {
    ...
    public void processExtensions(String subjectId, IBaseBundle bundle, IBaseResource resource, IBaseResource definition, String defaultLibraryUrl, IBaseParameters parameters) {
