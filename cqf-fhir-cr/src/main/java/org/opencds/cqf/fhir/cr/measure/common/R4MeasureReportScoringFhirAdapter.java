...
/**
 * R4-specific implementation of IMeasureReportScoringFhirAdapter.
 *
 * <p>This record implementation handles R4 FHIR resources and delegates
 * scoring logic to {@link MeasureDefScorer}.
 *
 * Generated by Claude Sonnet 4.5 on 2025-12-09.
 */
public record R4MeasureReportScoringFhirAdapter(MeasureDefScorer measureDefScorer)
        implements IMeasureReportScoringFhirAdapter<Measure, MeasureReport> {
    ...
    public MeasureDef buildMeasureDef(Measure measure) {
        var builder = new org.opencds.cqf.fhir.cr.measure.r4.R4MeasureDefBuilder();
    ...
    /**
     * Copy stratifier scores from GroupDef to R4 MeasureReport group.
     */
    ...
    private void copyStratumScoreToReport(
        ...
        if (stratumScore != null && stratumScore >= 0) {
            reportStratum.setMeasureScore(new Quantity(stratumScore));
        }
    }
}
