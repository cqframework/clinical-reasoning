...
import org.opencds.cqf.fhir.utility.r5.CRMIReleaseExperimentalBehavior.CRMIReleaseExperimentalBehaviorCodes;
...
public class KnowledgeArtifactReleaseVisitor {
    ...
    public static Bundle searchArtifactAssessmentForArtifact(IIdType reference, Repository repository) {
        ...
        Bundle searchResultsBundle = repository.search(Bundle.class, ArtifactAssessment.class, searchParams);
        ...
        searchArtifactAssessmentForArtifact(rootArtifact.getIdElement(), repository).getEntry().stream()
                ...
                .forEach(artifactComment -> {
                    ...
                    ra.setType(RelatedArtifactType.DERIVEDFROM)
                            .setResource(String.format("%s|%s", rootArtifact.getUrl(), releaseVersion));
