...
public class ContinuousVariableResourceMeasureObservationTest {
    ...
    class Avg {
        ...
        void continuousVariableResourceMeasureObservationBooleanBasisAvg() {
            ...
            GIVEN_BOOLEAN_BASIS
                    ...
                    .hasStratumCount(4)
                    .stratumByComponentValueText("male")
                    .hasComponentValueText("male")
                    ...
                    .up()
                    .up()
                    .stratumByComponentValueText("unknown")
                    .hasComponentValueText("unknown")
                    .hasScore("64.0")
                    .hasPopulationCount(4)
                    .population(MeasurePopulationType.INITIALPOPULATION)
                    .hasCount(1)
                    ...
                    .up()
                    .up()
                    .stratumByComponentValueText("other")
                    .hasComponentValueText("other")
                    ...
                    .up()
                    .up()
                    .stratumByComponentValueText("female")
                    .hasComponentValueText("female")
                    .hasScore("67.75")
                    .hasPopulationCount(4)
                    .population(MeasurePopulationType.INITIALPOPULATION)
                    .hasCount(4)
    ...
    class Count {
        ...
        void continuousVariableResourceMeasureObservationEncounterBasisCount() {
            ...
            GIVEN_ENCOUNTER_BASIS
                    ...
                    .stratifierById("stratifier-age")
                    .hasStratumCount(3)
                    .stratumByComponentValueText(Integer.toString(EXPECTED_ENCOUNTER_BASIS_AGE_STRATUM_1))
                    .hasComponentValueText(Integer.toString(EXPECTED_ENCOUNTER_BASIS_AGE_STRATUM_1))
                    .hasScore("2.0")
                    .hasPopulationCount(4)
                    .population(MeasurePopulationType.INITIALPOPULATION)
                    .hasCount(2)
                    ...
                    .up()
                    .up()
                    .stratumByComponentValueText(Integer.toString(EXPECTED_ENCOUNTER_BASIS_AGE_STRATUM_2))
                    .hasComponentValueText(Integer.toString(EXPECTED_ENCOUNTER_BASIS_AGE_STRATUM_2))
                    .hasScore("4.0")
                    .hasPopulationCount(4)
                    .population(MeasurePopulationType.INITIALPOPULATION)
                    .hasCount(5)
                    ...
                    .up()
                    .up()
                    .stratumByComponentValueText(Integer.toString(EXPECTED_ENCOUNTER_BASIS_AGE_STRATUM_3))
                    .hasComponentValueText(Integer.toString(EXPECTED_ENCOUNTER_BASIS_AGE_STRATUM_3))
    ...
    class Sum {
        ...
        /**
         * Test: Verify CV evaluation passes when population IDs differ from type codes.
         * This is a regression test for DQM-700: criteria references like "measure-population-1"
         * should be resolved by population ID, not compared directly against type codes.
         */
        @Test
        void continuousVariableResourceMeasureObservationEncounterBasisSumArbitraryIds() {

            GIVEN_ENCOUNTER_BASIS
                    .when()
                    .measureId("ContinuousVariableResourceMeasureObservationEncounterBasisSumArbitraryIds")
                    .evaluate()
                    .then()
                    .def()
                    .hasNoErrors()
                    .firstGroup()
                    .populationById("measure-population-1")
                    .hasSubjectCount(10)
                    .up()
                    .hasScore(2416.0)
                    .up()
