...
public class TestQuestionnaireResponse {
    ...
    public static org.opencds.cqf.fhir.cr.questionnaireresponse.QuestionnaireResponseProcessor buildProcessor(
        ...
        public GeneratedBundle extract() {
            ...
            return new GeneratedBundle(
                    (Bundle) buildProcessor(repository)
                            .extract(Eithers.forRight(questionnaireResponse), null, null, libraryEngine),
                    expectedBundle);
        }
    }
