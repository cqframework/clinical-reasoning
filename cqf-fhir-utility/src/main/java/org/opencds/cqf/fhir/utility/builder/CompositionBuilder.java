...
public class CompositionBuilder<T extends IDomainResource>
  ...
  protected void initializeDstu2(T theResource) {
    ...
    composition.setDate(new DateTimeDt(myDate))
        ...
        .setType(
            new CodeableConceptDt().addCoding(new CodingDt().setSystem(getTypeSetting().getSystem())
                .setCode(getTypeSetting().getCode()).setDisplay(getTypeSetting().getDisplay())))
  ...
  protected void initializeDstu2_1(T theResource) {
    ...
    composition.setDate(myDate)
        ...
        .setType(
            new CodeableConcept().addCoding(new Coding().setSystem(getTypeSetting().getSystem())
                .setCode(getTypeSetting().getCode()).setDisplay(getTypeSetting().getDisplay())))
  ...
  protected void initializeDstu2_HL7Org(T theResource) {
    ...
    composition.setDate(myDate)
        ...
        .setType(new org.hl7.fhir.dstu2.model.CodeableConcept()
            .addCoding(new org.hl7.fhir.dstu2.model.Coding().setSystem(getTypeSetting().getSystem())
                .setCode(getTypeSetting().getCode()).setDisplay(getTypeSetting().getDisplay())))
  ...
  protected void initializeDstu3(T theResource) {
    ...
    composition.setDate(myDate)
        ...
        .setType(new org.hl7.fhir.dstu3.model.CodeableConcept()
            .addCoding(new org.hl7.fhir.dstu3.model.Coding().setSystem(getTypeSetting().getSystem())
                .setCode(getTypeSetting().getCode()).setDisplay(getTypeSetting().getDisplay())))
  ...
  protected void initializeR4(T theResource) {
    ...
    composition.setDate(myDate)
        ...
        .setType(new org.hl7.fhir.r4.model.CodeableConcept()
            .addCoding(new org.hl7.fhir.r4.model.Coding().setSystem(getTypeSetting().getSystem())
                .setCode(getTypeSetting().getCode()).setDisplay(getTypeSetting().getDisplay())))
  ...
  protected void initializeR5(T theResource) {
    ...
    composition.setDate(myDate).setIdentifier(r5Identifiers)
        .setStatus(CompositionStatus.valueOf(myStatus)).setSubject(r5References).setTitle(myTitle)
        .setType(new org.hl7.fhir.r5.model.CodeableConcept()
            .addCoding(new org.hl7.fhir.r5.model.Coding().setSystem(getTypeSetting().getSystem())
                .setCode(getTypeSetting().getCode()).setDisplay(getTypeSetting().getDisplay())))
