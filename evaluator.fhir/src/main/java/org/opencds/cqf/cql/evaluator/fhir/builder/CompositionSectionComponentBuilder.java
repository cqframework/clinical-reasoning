...
public class CompositionSectionComponentBuilder<T extends IBaseBackboneElement>
    ...
    public CompositionSectionComponentBuilder(Class<T> theResourceClass, String theId,
            String theFocus, String theEntry) {
    ...
    protected void initializeDstu2(T theResource) {
        ...
        if (myText != null) {
            section.setText(new NarrativeDt(new XhtmlDt(myText.getText()),
                    NarrativeStatusEnum.valueOf(myText.getStatus())));
        }
        // no focus
    }
    ...
    protected void initializeDstu2_HL7Org(T theResource) {
        ...
        section.setTitle(myTitle).setId(getId());
        getEntries()
                .forEach(entry -> section.addEntry(new org.hl7.fhir.dstu2.model.Reference(entry)));
        if (myText != null) {
    ...
    protected void initializeDstu3(T theResource) {
        ...
        section.setTitle(myTitle).setId(getId());
        getEntries()
                .forEach(entry -> section.addEntry(new org.hl7.fhir.dstu3.model.Reference(entry)));
        if (myText != null) {
    ...
    protected void initializeR4(T theResource) {
        ...
        section.setFocus(new org.hl7.fhir.r4.model.Reference(myFocus)).setTitle(myTitle)
                .setId(getId());
    ...
    protected void initializeR5(T theResource) {
        ...
        section.setFocus(new org.hl7.fhir.r5.model.Reference(myFocus)).setTitle(myTitle)
                .setId(getId());
