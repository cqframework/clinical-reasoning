...
import org.opencds.cqf.fhir.cr.hapi.cdshooks.svc.cr.CdsCrUtils;
...
public class CrDiscoveryServiceDstu3 implements ICrDiscoveryService {
	...
	public Library resolvePrimaryLibrary(PlanDefinition planDefinition) {
		...
		if (planDefinition.hasLibrary()
				&& planDefinition.getLibraryFirstRep().hasReference()) {
	...
	protected StringBuilder getCodesStringBuilder(
			List<String> list, StringBuilder codes, String system, String code) {
