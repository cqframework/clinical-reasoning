...
public class PackageHelper {
  ...
  protected static final List<String> PACKABLE_RESOURCES =
      Arrays.asList(FHIRTypes.LIBRARY.toCode(), FHIRTypes.PLANDEFINITION.toCode(),
          FHIRTypes.ACTIVITYDEFINITION.toCode(), FHIRTypes.STRUCTUREDEFINITION.toCode(),
      ...
      if (artifact.getType().equals(RelatedArtifactType.DEPENDSON)
        ...
        try {
          ...
          if (PACKABLE_RESOURCES.contains(Canonicals.getResourceType(canonical))) {
            var resource =
                SearchHelper.searchRepositoryByCanonical(theRepository, canonical);
            if (resource != null
