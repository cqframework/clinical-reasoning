...
public interface LibraryProcessor {
     ...
     */
    IBaseParameters evaluate(IIdType id, String context, String patientId, String periodStart, String periodEnd,
     ...
     * @return IBaseParameters
     */
    IBaseParameters evaluate(VersionedIdentifier identifier, String context, String patientId, String periodStart,
     ...
     * @return IBaseParameters
     */
    IBaseParameters evaluate(String url, String context, String patientId, String periodStart, String periodEnd,
            String productLine, IBaseResource libraryEndpoint, IBaseResource terminologyEndpoint,
            IBaseResource dataEndpoint, IBaseParameters parameters, IBaseBundle additionalData,
            Set<String> expressions);
}