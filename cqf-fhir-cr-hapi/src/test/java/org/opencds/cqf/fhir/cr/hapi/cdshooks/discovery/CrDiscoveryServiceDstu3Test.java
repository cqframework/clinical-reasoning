...
class CrDiscoveryServiceDstu3Test extends BaseCdsCrDiscoveryServiceTest {
    ...
    private static final DataRequirement DATA_REQUIREMENT_PATIENT = new DataRequirement().setType(
        ResourceType.Patient.toString());
    private static final DataRequirement DATA_REQUIREMENT_ENCOUNTER = new DataRequirement().setType(
    ...
    private static final IdType LIBRARY_1_ID_TYPE = new IdType(ResourceType.Library.toString(),
        "lib1");
    private static final IdType LIBRARY_2_ID_TYPE = new IdType(ResourceType.Library.toString(),
        "lib2");
    private static final IdType LIBRARY_3_ID_TYPE = new IdType(ResourceType.Library.toString(),
        "lib3");
    private static final IdType LIBRARY_4_ID_TYPE = new IdType(ResourceType.Library.toString(),
        "lib4");
    private static final IdType LIBRARY_5_ID_TYPE = new IdType(ResourceType.Library.toString(),
        "lib5");
    private static final IdType LIBRARY_6_ID_TYPE = new IdType(ResourceType.Library.toString(),
        "lib6");

    private static final Library LIBRARY_1 = (Library) new Library().setId(LIBRARY_1_ID_TYPE);
    private static final Library LIBRARY_2 = (Library) new Library().setDataRequirement(List.of())
        .setId(LIBRARY_2_ID_TYPE);
    private static final Library LIBRARY_3 = (Library) new Library().setDataRequirement(List.of(
        DATA_REQUIREMENT_PATIENT)).setId(LIBRARY_3_ID_TYPE);
    private static final Library LIBRARY_4 = (Library) new Library().setDataRequirement(List.of(
        DATA_REQUIREMENT_ENCOUNTER)).setId(LIBRARY_4_ID_TYPE);
    ...
    private static final String PREFETCH_URL_PATIENT_WITH_PATH_AND_CODE =
        PREFETCH_URL_PATIENT + URL_PART_PATH_AND_CODE;
    ...
    private static Stream<Arguments> createRequestUrlParams() {
        return Stream.of(
            ...
            Arguments.of(
                DATA_REQUIREMENT_PATIENT,
                List.of(PREFETCH_URL_PATIENT)),
            Arguments.of(
                DATA_REQUIREMENT_PATIENT_CODE_FILTER_NO_CODING,
                List.of()),
            Arguments.of(
                DATA_REQUIREMENT_PATIENT_CODE_FILTER_CODING_EMPTY,
                List.of()),
            Arguments.of(
    ...
    private static Stream<Arguments> getPrefetchUrlListParams() {
        return Stream.of(
            ...
            Arguments.of(new PlanDefinition().setType(new CodeableConcept()),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of())),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(
                new CodeableConcept().setCoding(List.of(new Coding()))), PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(
                    new CodeableConcept().setCoding(List.of(CODING_NON_ECA_RULE))),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(new Reference(LIBRARY_1_ID_TYPE))),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(new Reference(LIBRARY_2_ID_TYPE))),
                PREFETCH_URL_LIST_EMPTY),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(new Reference(LIBRARY_3_ID_TYPE))),
                getPrefetchUrlList(
                    PREFETCH_URL_PATIENT)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(List.of(new Reference(LIBRARY_4_ID_TYPE))),
                getPrefetchUrlList(
                    PREFETCH_URL_ENCOUNTER)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                    idsToReferences(LIBRARY_3_ID_TYPE, LIBRARY_4_ID_TYPE)),
                getPrefetchUrlList(PREFETCH_URL_PATIENT)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                    idsToReferences(LIBRARY_5_ID_TYPE)),
                getPrefetchUrlList(PREFETCH_URL_PATIENT_WITH_PATH_AND_CODE)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                    idsToReferences(LIBRARY_6_ID_TYPE)),
                getPrefetchUrlList(PREFETCH_URL_ENCOUNTER_WITH_PATH_AND_CODE)),
            Arguments.of(new PlanDefinition().setType(new CodeableConcept().setCoding(List.of(
                    CODING_ECA_RULE))).setLibrary(
                    idsToReferences(LIBRARY_5_ID_TYPE, LIBRARY_6_ID_TYPE)),
                getPrefetchUrlList(PREFETCH_URL_PATIENT_WITH_PATH_AND_CODE))
        );
    }
