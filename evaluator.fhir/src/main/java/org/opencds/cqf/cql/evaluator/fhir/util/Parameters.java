...
public class Parameters {
	...
	/**
	 * Creates the appropriate parameters for a given FhirContext, IIDType, Ibase
	 * Parts
	 *
	 * @param theId       an IIdType type
	 * @param fhirContext the FhirContext for fhir API
	 * @param parts       IBase types as interface marker for convergence between
	 *                    Hapi and HL7
	...
	/**
	 * Creates the appropriate parameters for a given FhirContext, ID String, Ibase
	 * Parts
	 *
	...
	/**
	 * Creates new Ibase parts given FhirContext, part name to get, other Ibase
	 * Parts
	 *
	 * @param fhirContext the FhirContext for fhir API
	...
	/**
	 * Creates new Ibase parts given FhirContext, fhir element type, part name to
	 * get, Object instance, other Ibase Parts
	 *
	 ...
	 */
	public static Optional<String> getSingularStringPart(FhirContext fhirContext, IBaseResource parameters,
			String name) {
	...
	/**
	 * method get string named part from parameters using fhircontext, Parameters,
	 * and name
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create base64binary part from parameters using fhircontext, Parameter
	 * name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create boolean part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create canonical part from parameters using fhircontext, Parameter
	 * name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create code part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create date part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create datetime part from parameters using fhircontext, Parameter
	 * name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create decimal part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create ID part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create instant part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create integer part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create integer base 64 part from parameters using fhircontext,
	 * Parameter name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	 * @param value       part value
	...
	/**
	 * method create markdown part from parameters using fhircontext, Parameter
	 * name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create OID part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create postive int part from parameters using fhircontext, Parameter
	 * name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create string part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create time part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create unsigned int part from parameters using fhircontext, Parameter
	 * name, value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create uri part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create url part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
	...
	/**
	 * method create uuid part from parameters using fhircontext, Parameter name,
	 * value of parameter, parameter parts
	 *
	 * @param fhirContext the FhirContext for fhir AP I
	 * @param name        String representation of parameter name
