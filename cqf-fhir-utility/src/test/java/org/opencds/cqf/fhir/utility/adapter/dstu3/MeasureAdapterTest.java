...
class MeasureAdapterTest {
    ...
    void adapter_get_all_dependencies() {
        ...
        measure.getRelatedArtifactFirstRep()
    ...
    void adapter_get_all_dependencies_with_non_depends_on_related_artifacts() {
        ...
        library.setId("test");
        library.getRelatedArtifactFirstRep()
                .setResource(new Reference(dependencies.get(0)))
    ...
    private static Stream<Arguments> getLibraryParams() {
        return Stream.of(
                ...
                Arguments.of(
                        List.of(new Reference("library1"), new Reference("library2")),
                        List.of("library1", "library2")));
    }

    @ParameterizedTest
    @MethodSource("getLibraryParams")
    void getLibrary(List<Reference> measureLibraries, List<String> expectedAdapterLibraries) {
