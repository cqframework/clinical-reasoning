...
public class DirectoryBundler {
    ...
    private DirectoryBundler(FhirContext fhirContext) {
     ...
     * @param fhirContext An initialized FHIR context matching the version of the resources to bundle
     * @param path The root directory to bundle.
     * @return A Bundle of all the resources in the root directory and
     *         subdirectories
     */
    public static IBaseBundle bundle(FhirContext fhirContext, String path) {
