...
class IntervalHelperTest {
    ...
    private static DateTimeRange toDateTimeRange(LocalDateTime startLocalDateTime, ZoneOffset startZoneOffset, LocalDateTime endLocalDateTime, ZoneOffset endZoneOffset) {
        return new DateTimeRange(toDateTime(startLocalDateTime, startZoneOffset), toDateTime(endLocalDateTime, endZoneOffset));
    }
