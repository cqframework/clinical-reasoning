...
public class ExtensionBuilders {
    ...
    //            FhirVersionEnum fhirVersion, ICompositeType param) {
    //        return buildSdcLaunchContextExt(fhirVersion, param, null);
    //    }
    //
    //    @SuppressWarnings("unchecked")
    //    public static <T extends IBaseExtension<?, ?>> T buildSdcLaunchContextExt(
    //            FhirVersionEnum fhirVersion, ICompositeType param, List<String> resourceTypes) {
    //        var code = param
    ...
    //                code = "user";
    //                display = "User";
    //                acceptedResourceTypes = acceptedResourceTypes == null ? List.of("Practitioner") :
    ...
    //                acceptedResourceTypes.forEach(r -> r4Ext.addExtension("type", new
    // org.hl7.fhir.r4.model.CodeType(r)));
    //                return (T) r4Ext;
    //            case R5:
    ...
    //                acceptedResourceTypes.forEach(r -> r5Ext.addExtension("type", new
    // org.hl7.fhir.r5.model.CodeType(r)));
    //                return (T) r5Ext;
    //
    //            default:
    //                return null;
