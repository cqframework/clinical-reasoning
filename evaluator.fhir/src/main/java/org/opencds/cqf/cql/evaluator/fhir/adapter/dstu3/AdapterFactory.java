...
public class AdapterFactory implements org.opencds.cqf.cql.evaluator.fhir.adapter.AdapterFactory {
  ...
  @Override
  public org.opencds.cqf.cql.evaluator.fhir.adapter.ResourceAdapter createResource(
  ...
  @Override
  public org.opencds.cqf.cql.evaluator.fhir.adapter.LibraryAdapter createLibrary(
      IBaseResource library) {
    return new LibraryAdapter(library);
  }

  @Override
  public org.opencds.cqf.cql.evaluator.fhir.adapter.AttachmentAdapter createAttachment(
      ICompositeType attachment) {
    return new AttachmentAdapter(attachment);
  }

  @Override
  public org.opencds.cqf.cql.evaluator.fhir.adapter.ParametersAdapter createParameters(
