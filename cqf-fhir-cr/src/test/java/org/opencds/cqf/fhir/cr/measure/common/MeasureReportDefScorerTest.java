...
class MeasureReportDefScorerTest {
    ...
    //                "gender-stratifier", createTextOnlyConcept("Gender Stratifier"), "Gender",
    // MeasureStratifierType.VALUE);
    ...
    //                createPopulationDef("num-1", MeasurePopulationType.NUMERATOR, Set.of(), encounterBasis); // No
    // subjects
    //        PopulationDef denominatorPop = createPopulationDef(
    //                "den-1",
    //                MeasurePopulationType.DENOMINATOR,
    ...
    //                List.of(),
    //                List.of(initialPopulation, numeratorPop, denominatorPop, numeratorMeasureObs,
    // denominatorMeasureObs),
    //                MeasureScoring.RATIO,
    //                false,
    //                createImprovementNotationCode("increase"),
    ...
    //        CodeDef booleanBasis = createBooleanBasisCode();
    //        PopulationDef initialPopulation =
    //                createPopulationDef("ip-1", MeasurePopulationType.INITIALPOPULATION, Set.of("p1", "p2"),
    // booleanBasis);
    //
    ...
    //        MeasureObservationStratumCache femaleCache = new MeasureObservationStratumCache(femaleNumObs,
    // femaleDenObs);
    //
    //        StratumDef femaleStratum = new StratumDef(
    ...
    //        assertNotNull(maleDenObs.getAggregationResult(), "Male denominator stratum should have aggregation
    // result");
    //        assertEquals(20.0, maleDenObs.getAggregationResult(), 0.001);
    //
    //        // Female: num_agg=30 (10+20), den_agg=10 (4+6)
    //        assertNotNull(femaleNumObs.getAggregationResult(), "Female numerator stratum should have aggregation
    // result");
    //        assertEquals(30.0, femaleNumObs.getAggregationResult(), 0.001);
    //        assertNotNull(femaleDenObs.getAggregationResult(), "Female denominator stratum should have aggregation
    // result");
    ...
    // booleanBasis);
    //        PopulationDef measurePopulation = createPopulationDef(
    //                "mp-1", MeasurePopulationType.MEASUREPOPULATION, Set.of("p1", "p2", "p3", "p4", "p5"),
    // booleanBasis);
    //
    //        ConceptDef measureObsCode = createMeasurePopulationConcept(MeasurePopulationType.MEASUREOBSERVATION);
    //        PopulationDef measureObsPop = new PopulationDef(
    ...
    //                initialPopulation, Set.of("p4", "p5"), Set.of(), List.of(), MeasureStratifierType.VALUE,
    // booleanBasis);
    //        StratumPopulationDef femaleMpPop = new StratumPopulationDef(
    //                measurePopulation, Set.of("p4", "p5"), Set.of(), List.of(), MeasureStratifierType.VALUE,
    // booleanBasis);
    //        StratumPopulationDef femaleMsrObsPop = new StratumPopulationDef(
    //                measureObsPop, Set.of("p4", "p5"), Set.of(), List.of(), MeasureStratifierType.VALUE,
    // booleanBasis);
    //
    //        StratumDef femaleStratum = new StratumDef(
    ...
    //                denominatorPop, Set.of("p1", "p2"), Set.of(), List.of(), MeasureStratifierType.VALUE,
    // booleanBasis);
    //
    //        StratifierComponentDef component = new StratifierComponentDef("comp-1", createTextOnlyConcept("Test"),
    // "Test");
