...
public class HashMapForFhirResourcesAndCqlTypes<K, V> extends HashMap<K, V> {
    ...
    public boolean containsKey(Object key) {
        return CqlFhirResourceAndCqlTypeUtils.findMatchingKey(this, key) != null;
    }
    ...
    public boolean containsValue(Object value) {
        return CqlFhirResourceAndCqlTypeUtils.findMatchingValue(this, value) != null;
    }
    ...
    public V get(Object key) {
        K matchingKey = CqlFhirResourceAndCqlTypeUtils.findMatchingKey(this, key);
        if (matchingKey != null) {
    ...
    public boolean remove(Object key, Object value) {
        ...
        if (matchingKey != null) {
            ...
            if (CqlFhirResourceAndCqlTypeUtils.areObjectsEqual(existingValue, value)) {
    ...
    public boolean replace(K key, V oldValue, V newValue) {
        ...
        if (matchingKey != null) {
            V existingValue = super.get(matchingKey);
            if (CqlFhirResourceAndCqlTypeUtils.areObjectsEqual(existingValue, oldValue)) {
