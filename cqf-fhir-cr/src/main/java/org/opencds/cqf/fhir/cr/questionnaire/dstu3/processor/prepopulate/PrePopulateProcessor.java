...
import static org.opencds.cqf.fhir.cr.common.ExtensionBuilders.buildDstu3;
...
public class PrePopulateProcessor {
    ...
    public Questionnaire prePopulate(Questionnaire questionnaire, PrePopulateRequest prePopulateRequest) {
        ...
        prepopulatedQuestionnaire.addExtension(buildDstu3(
                prepopulateSubjectExtension(FHIRAllTypes.PATIENT.toCode(), prePopulateRequest.getPatientId())));
        ...
        if (!operationOutcome.getIssue().isEmpty()) {
            ...
            prepopulatedQuestionnaire.addExtension(buildDstu3(crmiMessagesExtension(operationOutcome.getIdPart())));
        }
