...
import org.opencds.cqf.fhir.utility.visitor.r5.KnowledgeArtifactReleaseVisitor;
...
public class KnowledgeArtifactAdapterReleaseVisitorTests {
  ...
  void visitLibraryTest() {
    ...
    // org.opencds.cqf.fhir.utility.visitor.r5.KnowledgeArtifactReleaseVisitor releaseVisitor = new KnowledgeArtifactReleaseVisitor();
