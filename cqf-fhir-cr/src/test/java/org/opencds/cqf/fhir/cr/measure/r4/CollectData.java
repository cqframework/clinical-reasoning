...
import org.opencds.cqf.fhir.cr.measure.r4.CareGaps.Selected;
import org.opencds.cqf.fhir.cr.measure.r4.CareGaps.SelectedBundle;
import org.opencds.cqf.fhir.cr.measure.r4.CareGaps.SelectedDetectedIssue;
import org.opencds.cqf.fhir.cr.measure.r4.CareGaps.SelectedReport;
import org.opencds.cqf.fhir.cr.measure.r4.CareGaps.Selector;
...
public class CollectData {
    ...
    public static class When {
        ...
        public When collectData() {
            this.operation = () -> service.collectData(
                    theId,
                    periodStart,
                    periodEnd,
                    subject,
    ...
    public static class SelectedReport extends Selected<Parameters, Void> {
        ...
        public SelectedMeasureReport measureReport(
            CollectData.Selector<MeasureReport, Parameters> paramSelector) {
        ...
        public SelectedReport hasMeasureReportCount(int count) {
            assertEquals(count, report().getParameter().stream().filter(x -> x.getResource().getResourceType().toString().equals("MeasureReport")).collect(
    ...
    static class SelectedMeasureReport extends CollectData.Selected<MeasureReport, SelectedReport> {
        ...
        public CollectData.SelectedMeasureReport hasDataCollectionReportType() {
            assertEquals(MeasureReport.MeasureReportType.DATACOLLECTION, measureReport().getType());
            return this;
        }
    }
