...
class ParametersTest {
    ...
    void testParametersPartTypes() {
        org.hl7.fhir.r5.model.Parameters parameters = parameters(
                ...
                timePart("r5TimePart", "12:30:30.500"), unsignedIntPart("r5UnsignedIntPart", 0),
        ...
        assertEquals("urn:oid:1.2.3.4.5",
                ((org.hl7.fhir.r5.model.OidType) r5Type).getValueAsString());
        ...
        assertEquals("example string",
                ((org.hl7.fhir.r5.model.StringType) r5Type).getValueAsString());
