...
public abstract class RetrieveProvider extends TerminologyAwareRetrieveProvider {
  ...
  public Predicate<IBaseResource> filterByTemplateId(final String dataType,
  ...
  public Predicate<IBaseResource> filterByContext(final String dataType,
    ...
    return (IBaseResource res) -> {
      ...
      if (resContextValue.isPresent() && resContextValue.get() instanceof IIdType) {
        ...
        if (referenceString.contains("/")) {
          referenceString =
              referenceString.substring(referenceString.indexOf("/") + 1);
        }
  ...
  public Predicate<IBaseResource> filterByTerminology(final String dataType,
  ...
  private String getValueSetFromCode(IBase base) {
    IBaseExtension<?, ?> ext = ExtensionUtil.getExtensionByUrl(base,
  ...
  public void populateContextSearchParams(Map<String, List<IQueryParameterType>> searchParams,
      final String contextPath, final String context, final Object contextValue) {
  ...
  public void populateTerminologySearchParams(Map<String, List<IQueryParameterType>> searchParams,
      final String codePath, final Iterable<Code> codes, final String valueSet) {
  ...
  public void populateDateSearchParams(Map<String, List<IQueryParameterType>> searchParams,
