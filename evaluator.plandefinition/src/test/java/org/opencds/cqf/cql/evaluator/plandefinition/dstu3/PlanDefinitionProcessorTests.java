...
public class PlanDefinitionProcessorTests extends PlanDefinition {
    ...
    public void testChildRoutineVisit() {
        PlanDefinition.Assert
                .that("ChildRoutineVisit-PlanDefinition-1.0.0", "Patient/ChildRoutine-Reportable",
                        null)
    ...
    public void testOpioidRec10PatientView() {
        /*
         * NOTE: All dynamicValues with the path equaling action.extension have been removed from
         * the plandefinition until the issue in the link
         * https://github.com/DBCG/cqf-ruler/issues/539 has been resolved.
         */
        PlanDefinition.Assert
                ...
                .withLibrary("opioid-Rec10-patient-view/opioid-Rec10-patient-view-bundle.json")
                .apply()
    ...
    public void testQuestionnairePrepopulate() {
        PlanDefinition.Assert.that("prepopulate", "OPA-Patient1", null)
                ...
                .withParameters(new Parameters().addParameter(
                        new Parameters.ParametersParameterComponent(new StringType("ClaimId"))
