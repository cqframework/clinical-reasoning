...
import org.opencds.cqf.cql.evaluator.fhir.adapter.r4.KnowledgeArtifactAdapter;
import org.opencds.cqf.cql.evaluator.fhir.util.Canonicals;
import org.opencds.cqf.cql.evaluator.fhir.util.DependencyInfo;
import org.opencds.cqf.cql.evaluator.fhir.util.r4.ResourceClassMapHelper;
...
public class KnowledgeArtifactDraftVisitor implements KnowledgeArtifactVisitor  {
  public void visit(LibraryAdapter library, Repository theFhirRepository) {
  ...
  private List<DependencyInfo> combineComponentsAndDependencies(LibraryAdapter adapter) {
