...
public class R4MeasureReportAggregatorTest {
  ...
  public void aggregateReports_combines_reports() {
    ...
    assertTrue(actual.getExtension().stream()
        .anyMatch(item -> item.getUrl().equals(
  ...
  public void aggregateReports_subject_listType_combines_reports() {
    ...
    MeasureReport left = (MeasureReport) parser.parseResource(R4MeasureReportAggregatorTest.class
        .getResourceAsStream("AggregateReport-subject-list1.json"));
    assertNotNull(left);

    MeasureReport right = (MeasureReport) parser.parseResource(R4MeasureReportAggregatorTest.class
